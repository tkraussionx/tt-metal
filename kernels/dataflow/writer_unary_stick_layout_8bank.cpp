...
void kernel_main() {
    ...
    volatile uint32_t* dbox0 = reinterpret_cast<volatile uint32_t*>(l1_mem::address_map::TRISC0_DEBUG_BUFFER_BASE);
    volatile uint32_t* dbox1 = reinterpret_cast<volatile uint32_t*>(l1_mem::address_map::TRISC1_DEBUG_BUFFER_BASE);
