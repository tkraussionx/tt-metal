...
inline Tensor bert_large_ff1_matmul(const Tensor &input_tensor_a, const Tensor &input_tensor_b, std::optional<const Tensor> bias, bool fuse_gelu_activation, const MemoryConfig& mem_config) {
    return operation::run(BertLargeMatmul{BertLargeMatmulOpType::FF1, mem_config, input_tensor_a.dtype(), fuse_gelu_activation}, {input_tensor_a, input_tensor_b}, {bias}).at(0);
}
inline Tensor bert_large_ff2_matmul(const Tensor &input_tensor_a, const Tensor &input_tensor_b, std::optional<const Tensor> bias, const MemoryConfig& mem_config) {
    return operation::run(BertLargeMatmul{BertLargeMatmulOpType::FF2, mem_config, input_tensor_a.dtype(), false}, {input_tensor_a, input_tensor_b}, {bias}).at(0);
}
inline Tensor bert_large_selfout_matmul(const Tensor &input_tensor_a, const Tensor &input_tensor_b, std::optional<const Tensor> bias, const MemoryConfig& mem_config) {
    return operation::run(BertLargeMatmul{BertLargeMatmulOpType::SELFOUT, mem_config, input_tensor_a.dtype(), false}, {input_tensor_a, input_tensor_b}, {bias}).at(0);
}
inline Tensor bert_large_pre_softmax_bmm(const Tensor &input_tensor_a, const Tensor &input_tensor_b, const MemoryConfig& mem_config) {
    return operation::run(BertLargeMatmul{BertLargeMatmulOpType::PRE_SOFTMAX_BMM, mem_config, input_tensor_a.dtype(), false}, {input_tensor_a, input_tensor_b}, {std::nullopt}).at(0);
}
inline Tensor bert_large_post_softmax_bmm(const Tensor &input_tensor_a, const Tensor &input_tensor_b, const MemoryConfig& mem_config) {
    return operation::run(BertLargeMatmul{BertLargeMatmulOpType::POST_SOFTMAX_BMM, mem_config, input_tensor_a.dtype(), false}, {input_tensor_a, input_tensor_b}, {std::nullopt}).at(0);
}
