...
Tensor eltwise_unary_single_core (const Tensor &a, UnaryOpType::Enum op_type, uint32_t call_count = 0);
Tensor eltwise_unary_multi_core (const Tensor &a, UnaryOpType::Enum op_type, uint32_t call_count = 0);
