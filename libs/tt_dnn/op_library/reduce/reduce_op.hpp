...
Tensor reduce_single_core(const Tensor &a, ReduceOpMath::Enum reduce_math, ReduceOpDim::Enum reduce_dim, float scaler = 1.0f, uint32_t call_count = 0);
Tensor reduce_multi_core_h(const Tensor &a, ReduceOpMath::Enum reduce_math, ReduceOpDim::Enum reduce_dim, float scaler = 1.0f, uint32_t call_count = 0);
Tensor reduce_multi_core_w(const Tensor &a, ReduceOpMath::Enum reduce_math, ReduceOpDim::Enum reduce_dim, float scaler = 1.0f, uint32_t call_count = 0);
Tensor reduce_multi_core_hw(const Tensor &a, ReduceOpMath::Enum reduce_math, ReduceOpDim::Enum reduce_dim, float scaler = 1.0f, uint32_t call_count = 0);
