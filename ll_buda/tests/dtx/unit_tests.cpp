...
bool run_DataTransformation_test_4(bool DEBUG) {
    bool pass = true;

    if (DEBUG) cout << "======================================\nrun_DataTransformation_test_4\n======================================" << endl;
    ...
    // NODE 0:
    node0->groups[0]->shape = {1,1,1,4};

    // NODE 1:
    node1->groups[0]->shape = {1,1,4,1};
    node1->groups[0]->tensor_pairs.push_back(  new TensorPair( new Tensor({0,0,0,0},  {0,0,0,3}), 0, new Tensor({0,0,0,0},  {0,0,3,0}))  );

    // NODE 2:
    node2->groups[0]->shape = {1,1,4,1};
    node2->groups[0]->tensor_pairs.push_back(  new TensorPair( new Tensor({0,0,0,0},  {0,0,3,0}), 0,  new Tensor({0,0,0,0}, {0,0,3,0}))   );
...
bool run_DataTransformation_test_5(bool DEBUG) {
    bool pass = true;

    if (DEBUG) cout << "======================================\nrun_DataTransformation_test_5\n======================================" << endl;
    ...
    // NODE 1:
    node1->groups[0]->shape = {1,1,2,2};
    node1->groups[0]->tensor_pairs.push_back(  new TensorPair( new Tensor({0,0,0,0},  {0,0,0,1}), 0, new Tensor({0,0,0,0},  {0,0,0,1}))  );
    node1->groups[0]->tensor_pairs.push_back(  new TensorPair( new Tensor({0,0,0,2},  {0,0,0,3}), 0, new Tensor({0,0,1,0},  {0,0,1,1}))  );

    // NODE 2:
    node2->groups[0]->shape = {1,1,1,4};
    node2->groups[0]->tensor_pairs.push_back(  new TensorPair( new Tensor({0,0,0,0},  {0,0,0,1}), 0,  new Tensor({0,0,0,0}, {0,0,0,1}))   );
    node2->groups[0]->tensor_pairs.push_back(  new TensorPair( new Tensor({0,0,1,0},  {0,0,1,1}), 0,  new Tensor({0,0,0,2}, {0,0,0,3}))   );
...
bool test_DataTransformations() {
    ...
    pass &= run_DataTransformation_test_4(DEBUG);
    //pass &= run_DataTransformation_test_5(DEBUG);
    return pass;
}
