...
import tt_lib
from models.utility_functions import torch_to_tt_tensor, torch_to_tt_tensor_rm
...
class TtBloomMLP(nn.Module):
    def __init__(self, config, state_dict, base_address, device):
        ...
        self.dense_h_to_4h_weight = torch_to_tt_tensor(
        ...
        self.dense_4h_to_h_weight = torch_to_tt_tensor(
