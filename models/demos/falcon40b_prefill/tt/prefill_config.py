...
def get_model_config(model_config_str):
    ...
    if model_config_str in ACCEPTABLE_MODEL_CONFIG_STRS:
        print(f"Using model config: {model_config_str}")
    ...
    model_config = {
        ...
        "DEFAULT_CACHE_PATH": Path(f"models/demos/falcon40b_prefill/datasets/"),
    }
