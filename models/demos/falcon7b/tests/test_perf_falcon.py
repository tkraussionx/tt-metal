...
class TestParametrized:
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            ("prefill", 32, 1, 2048, 0, "BFLOAT16-DRAM", 0.99, 0.99, 0.99, 1.1),
    ...
    #     (
    #         ("prefill", 4, 32, 1, 128, 0, "BFLOAT16-DRAM", 0.99, 0.99, 0.99, 0.1, False),
    #         ("prefill", 4, 32, 1, 256, 0, "BFLOAT16-DRAM", 0.99, 0.99, 0.98, 0.18, False),  # Issue 7816 Inference time
    #         ("prefill", 4, 32, 1, 1024, 0, "BFLOAT16-DRAM", 0.99, 0.99, 0.99, 0.5, False),
    #         ("prefill", 4, 32, 1, 2048, 0, "BFLOAT16-DRAM", 0.99, 0.99, 0.99, 1.1, False),
    #         ("decode", 4, 32, 32, 1, 1024, "BFLOAT16-L1_SHARDED", 0.87, 0.91, 0.91, 0.21, False),
    #         ("prefill", 4, 32, 1, 128, 0, "BFLOAT16-DRAM", 0.99, 0.99, 0.99, 0.1, True),
    #         ("prefill", 4, 32, 1, 256, 0, "BFLOAT16-DRAM", 0.99, 0.99, 0.98, 0.18, True),
    #         ("prefill", 4, 32, 1, 1024, 0, "BFLOAT16-DRAM", 0.99, 0.99, 0.99, 0.5, True),
    #         ("prefill", 4, 32, 1, 2048, 0, "BFLOAT16-DRAM", 0.99, 0.99, 0.99, 1.1, True),
