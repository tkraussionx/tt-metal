...
@pytest.mark.parametrize(
    "model_version, num_layers, batch, pcc",
    (
        (
...
def test_mamba_model_inference(
    ...
    reference_output = MambaPytorch(reference_model, num_layers)(input_ids)

    mamba_model = MambaTT(reference_model, num_layers, device)
