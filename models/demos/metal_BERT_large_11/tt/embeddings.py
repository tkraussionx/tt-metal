...
class TtEmbeddings:
    ...
    def __call__(
        ...
        inputs_embeds = ttnn.embedding(
            ...
            embeddings_type=ttnn._ttnn.operations.embedding.EmbeddingsType.PADDED,
        ...
        token_type_embeddings = ttnn.embedding(
            ...
            layout=ttnn.TILE_LAYOUT,
            embeddings_type=ttnn._ttnn.operations.embedding.EmbeddingsType.BINARY,
            output_mem_config=self.model_config["OUTPUT_EMBEDDINGS_MEMCFG"],
        )
        ...
        if self.position_embedding_type == "absolute":
            ...
            position_embeddings_tt_tensor = ttnn.embedding(
                ...
                layout=ttnn.TILE_LAYOUT,
                embeddings_type=ttnn._ttnn.operations.embedding.EmbeddingsType.GENERIC,
                output_mem_config=self.model_config["OUTPUT_EMBEDDINGS_MEMCFG"],
            )
