...
def top_2(gate_logits_1SB8, top_2_mask, expert_mask, ones_1118, ones_11B1, compute_kernel, device_mesh):
    ...
    # print("done eq", ttnn.to_torch(gate_logits_1SB8, mesh_composer=ConcatMeshToTensor(device_mesh, dim=0)))
    ...
    # print("tt weights", ttnn.to_torch(ttnn.get_device_tensors(weights_ex0_1SB1)[0]), ttnn.to_torch(ttnn.get_device_tensors(weights_ex1_1SB1)[0]))
    # print("tt conds", ttnn.to_torch(ttnn.get_device_tensors(cond0)[0]), ttnn.to_torch(ttnn.get_device_tensors(cond1)[0]))
    ...
    # print("done cond", ttnn.to_torch(cond0+cond1, mesh_composer=ConcatMeshToTensor(device_mesh, dim=0)))
...
class TtMoeLayer(torch.nn.Module):
    ...
    def forward(self, inputs):
        ...
        # weights = ttnn.to_device(weights, self.device_mesh)
