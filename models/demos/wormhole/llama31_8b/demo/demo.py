...
def run_llama_demo(user_input, batch_size, device, instruct_mode):
...
def test_demo(device, use_program_cache, input_prompts, instruct_weights):
    return run_llama_demo(user_input=input_prompts, batch_size=32, device=device, instruct_mode=instruct_weights)
