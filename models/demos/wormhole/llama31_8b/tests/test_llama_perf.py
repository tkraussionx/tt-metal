...
def test_llama_model_perf(
    ...
    prep_perf_report(
        model_name=f"Llama31_8B_{comment}",
...
def test_llama_perf_device(batch, iterations, expected_perf, reset_seeds):
    subdir = "ttnn_llama31_8b"
    margin = 0.03
    command = f"pytest models/demos/wormhole/llama31_8b/tests/test_llama_model.py::test_llama_model_inference[{iterations}-generative]"
