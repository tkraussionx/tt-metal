...
from models.demos.wormhole.mamba.benchmarks.loglikelihood import (
    ...
    compute_loglikelihood_given_prompt_and_target_for_wh,
)
from models.demos.wormhole.mamba.demo.demo import get_tt_metal_model, get_tokenizer
    ...
    def loglikelihood(self, requests: List[Instance]):
        ...
        with torch.no_grad():
            for instance in tqdm(requests):
                ...
                loglikelihood, is_greedy = compute_loglikelihood_given_prompt_and_target_for_wh(
                    context_ids,
                    target_ids,
                    self.model,
                    self.vocab_size,
