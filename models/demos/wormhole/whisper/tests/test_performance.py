...
from models.utility_functions import is_wormhole_b0, is_grayskull, skip_for_grayskull
from models.perf.device_perf_utils import run_device_perf, check_device_perf, prep_device_perf_report


def get_expected_times(functional_whisper):
    return {
        ttnn_optimized_functional_whisper: (47, 14),
    }[functional_whisper]
...
@pytest.mark.parametrize(
    ...
    [
        [
            16,
            "silicon_arch_name=wormhole_b0-silicon_arch_wormhole_b0=True-ttnn_model=models.demos.wormhole.whisper.tt.ttnn_optimized_functional_whisper-model_name=openai/whisper-base-batch_size=16",
        ],
    ],
)
