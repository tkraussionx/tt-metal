...
def test_reproduce_matmul_1d_hang(
    num_devices,
    all_devices,
    use_program_cache,
    ...
    a_shape = [1, 1, 8192, 576]
    b_shape = [1, 1, 576, 2304]
...
def test_specific_chip_reproduce_matmul_1d_hang_t3000(all_devices, logical_chip_index, use_program_cache):
    num_devices_t3000 = 8
    ...
    test_reproduce_matmul_1d_hang(1, devices, use_program_cache)
