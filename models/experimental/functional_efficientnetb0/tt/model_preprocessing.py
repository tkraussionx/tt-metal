...
def create_efficientnetb0_model_parameters(model: Efficientnetb0, input_tensor, device):
    ...
    # print((parameters._blocks0.module._bn1.weight).shape, (parameters._blocks0.module._bn1.bias).shape, (parameters._blocks0.module._bn1.running_mean).shape, (parameters._blocks0.module._bn1.running_var).shape,
    #       )
    # ss
