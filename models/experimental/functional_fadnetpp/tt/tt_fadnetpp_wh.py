...
from models.experimental.functional_fadnetpp.tt.ttnn_dispnetc_wh import TtDispNetC
from models.experimental.functional_fadnetpp.tt.tt_dispnetres_wh import TtDispNetRes
import ttnn
import torch
...
class TtFadNetPP(nn.Module):
    ...
    def __init__(self, parameters, device, in_planes, model):
        ...
        self.dispnetres = TtDispNetRes(device, parameters.dispnetres, in_planes, model.dispnetres)
