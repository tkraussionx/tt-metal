...
class ttCUNet:
    ...
    def __init__(self, parameters, model, resBlock=True) -> None:
        ...
        if self.resBlock:
            self.conv_redir = TtResBlock(parameters.conv_redir, 128, 32, model.conv_redir, stride=1)
            ...
            self.conv5 = TtResBlock(parameters.conv5, self.basicE * 8, self.basicE * 16, model.conv5, stride=2)
