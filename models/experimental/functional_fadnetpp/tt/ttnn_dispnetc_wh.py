...
from models.experimental.functional_fadnetpp.tt.ttnn_extractnet_wh import ttExtractNet
from models.experimental.functional_fadnetpp.tt.ttnn_cunet_wh import ttCUNet
import ttnn
...
class TtDispNetC:
    ...
    def __init__(self, parameters, model, resBlock=True) -> None:
        super().__init__()
        self.maxdisp = 192
        self.extractnet = ttExtractNet(parameters.extractnet, model.dispnetc.extractnet)
        self.cunet = ttCUNet(parameters.cunet, model.dispnetc.cunet)
