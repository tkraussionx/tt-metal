...
from models.experimental.functional_unet_new_conv_api.tt.common import Conv
...
class UNet:
    ...
    def __call__(self, device, input_tensor, original_shape, perf_mode=False):
        ...
        save_c1_2_out = ttnn.to_memory_config(save_c1_2_out, memory_config=ttnn.DRAM_MEMORY_CONFIG)
        ...
        output_tensor = self.c8(device, out_concat)
