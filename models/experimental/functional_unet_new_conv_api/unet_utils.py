...
from models.experimental.functional_unet_new_conv_api.tt import unet_shallow_torch
from models.experimental.functional_unet_new_conv_api.tt import unet_shallow_ttnn


def create_unet_models(device, batch, groups, torch_input_tensor):
    ...
    ttnn_model = unet_shallow_ttnn.UNet(device, parameters, batch, torch_model)
