...
def vit_attention(
    ...
    *_, hidden_size = hidden_states.shape
    ...
    query_key_value = ttnn.linear(
        ...
        memory_config=ttnn.L1_MEMORY_CONFIG,  # memory_config=ttnn.L1_BLOCK_SHARDED_MEMORY_CONFIG,
    ...
    (
        ...
        query_key_value,
        memory_config=ttnn.L1_MEMORY_CONFIG,  # ttnn.L1_HEIGHT_SHARDED_MEMORY_CONFIG,
        num_heads=num_heads,
    )
    ...
    context_layer = ttnn.matmul(
        attention_probs,
        value,
        memory_config=ttnn.L1_MEMORY_CONFIG,  # L1_HEIGHT_SHARDED_MEMORY_CONFIG,
        dtype=ttnn.bfloat8_b,
...
def vit_output(
    ...
    *,
    ...
    output = ttnn.add(
        output, residual, dtype=ttnn.bfloat8_b
    )  # memory_config=ttnn.L1_BLOCK_SHARDED_MEMORY_CONFIG, dtype=ttnn.bfloat8_b)
...
def vit(
    ...
    classifier_output = ttnn.gelu(classifier_output)
