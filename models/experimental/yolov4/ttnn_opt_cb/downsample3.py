...
class Down3:
    def __init__(self, model) -> None:
        ...
        self.res1_conv1 = Conv(
            torch_model,
            "down3.resblock.module_list.0.0",
            [1, 40, 40, 128],
            (1, 1, 0, 0),
        )
        ...
        self.res2_conv1 = Conv(
            torch_model,
            "down3.resblock.module_list.1.0",
            [1, 40, 40, 128],
            (1, 1, 0, 0),
        )
        ...
        self.res3_conv1 = Conv(
            torch_model,
            "down3.resblock.module_list.2.0",
            [1, 40, 40, 128],
            (1, 1, 0, 0),
        )
        ...
        self.res4_conv1 = Conv(
            torch_model,
            "down3.resblock.module_list.3.0",
            [1, 40, 40, 128],
            (1, 1, 0, 0),
        )
        ...
        self.res5_conv1 = Conv(
            torch_model,
            "down3.resblock.module_list.4.0",
            [1, 40, 40, 128],
            (1, 1, 0, 0),
        )
        ...
        self.res6_conv1 = Conv(
            torch_model,
            "down3.resblock.module_list.5.0",
            [1, 40, 40, 128],
            (1, 1, 0, 0),
        )
        ...
        self.res7_conv1 = Conv(
            torch_model,
            "down3.resblock.module_list.6.0",
            [1, 40, 40, 128],
            (1, 1, 0, 0),
        )
        ...
        self.res8_conv1 = Conv(
            torch_model,
            "down3.resblock.module_list.7.0",
            [1, 40, 40, 128],
            (1, 1, 0, 0),
        )
