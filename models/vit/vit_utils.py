...
def make_linear(in_feature, out_feature, op_name, state_dict, base_address, device, mem_config=tt_lib.tensor.MemoryConfig(ttl.tensor.TensorMemoryLayout.INTERLEAVED, tt_lib.tensor.BufferType.DRAM)):
