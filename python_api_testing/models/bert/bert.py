...
class TtBertShared(torch.nn.Module):
    @abstractmethod
    def __init__(self, hugging_face_reference_model, device):
        super().__init__()
        ...
        self.encoders = TtBertEncoder(state_dict, device)
        self.device = device
...
class TtBertForQuestionAnswering(TtBertShared):
    def __init__(self, hugging_face_reference_model, device):
        super().__init__(hugging_face_reference_model, device)
...
def run_bert_question_and_answering_inference():
    ...
    tt_bert_model = TtBertForQuestionAnswering(hugging_face_reference_model, device)
