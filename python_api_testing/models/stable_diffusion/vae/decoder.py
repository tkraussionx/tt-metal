...
from python_api_testing.models.stable_diffusion.unet.unet_2d_blocks import UNetMidBlock2D, UpDecoderBlock2D
...
class Decoder(nn.Module):
    ...
    def forward(self, z):
        ...
        sample = move_to_cpu(sample, self.host)
...
def run_vae_decoder_inference(device):
    ...
    tt_out = tt_encoder(tt_input).to(host).data()
