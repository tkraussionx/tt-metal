...
2. Access the Analysis Tool:
   - Open the link: //tt-graph.streamlit.app/.
3. Select Device:
...
- ### Setting MathFidelity to LoFi
    ...
    The graph below shows that using math_fidelity LoFi for convolution, instead of HiFi4, has decreased the convolution usage percentage from 44.7% to 39.1%.
