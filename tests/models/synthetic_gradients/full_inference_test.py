...
def run_full_inference(in_features, hidden_features, out_features, device):
    ...
    weight1_lin_tt = ttl.tensor.Tensor(
    ...
    bias1_lin_tt = ttl.tensor.Tensor(
    ...
    running_mean1_tt = ttl.tensor.Tensor(
    ...
    running_var1_tt = ttl.tensor.Tensor(
    ...
    weight2_lin_tt = ttl.tensor.Tensor(
    ...
    bias2_lin_tt = ttl.tensor.Tensor(
    ...
    running_mean2_tt = ttl.tensor.Tensor(
    ...
    running_var2_tt = ttl.tensor.Tensor(
