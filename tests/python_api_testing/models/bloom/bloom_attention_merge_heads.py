...
def tt_merge_heads(x: torch.Tensor, num_heads, hidden_size, num_attention_heads, device) -> torch.Tensor:
    ...
    tt_reshaped = tt_lib.tensor.reshape(tt_x, batch_size, num_heads, seq_length, head_dim)
    ...
    reshaped_2 = tt_lib.tensor.reshape(tt_permuted, 1, batch_size, seq_length, num_heads*head_dim)
