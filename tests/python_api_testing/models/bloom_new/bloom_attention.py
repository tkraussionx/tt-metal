...
class TtBloomAttention(torch.nn.Module):
    ...
    def forward(
        ...
        reshaped_query_layer = tt_lib.tensor.reshape(query_layer, 1, batch_size * self.num_heads, q_length, self.head_dim)
        ...
        reshaped_value_layer = tt_lib.tensor.reshape(value_layer, 1, batch_size * self.num_heads, q_length, self.head_dim)
