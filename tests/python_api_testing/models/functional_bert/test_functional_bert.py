...
from tests.python_api_testing.models.functional_bert.torch_functional_bert import (
    torch_bert_for_question_answering,
)
from tests.python_api_testing.models.functional_bert.parameters import (
...
class MatmulConfig:
    ...
    output_mem_config: MemoryConfig = MemoryConfig(True, BufferType.DRAM)
...
def tt_bert_preprocess_inputs(
    ...
    **kwargs,
    ...
    embeddings = (
        ...
        .to(kwargs["device"], MemoryConfig(True, BufferType.L1))
    )
...
def create_bert_multi_head_attention_config(batch_size):
    return MultiHeadAttentionConfig(
        ...
        concatenate_heads_output_mem_config=MemoryConfig(True, BufferType.L1),
    )
