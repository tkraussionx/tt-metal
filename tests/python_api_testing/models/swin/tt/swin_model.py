...
from python_api_testing.models.swin.tt.swin_encoder import TtSwinEncoder
...
class TtSwinModel(nn.Module):
    ...
    def forward(
        ...
        pt_sequence_output = tt_to_torch_tensor(sequence_output, self.host).squeeze(0)
        name = "tt_encoder_output_in_swin_model.pkl"

        with open(name, "wb") as file:
            pickle.dump(pt_sequence_output, file)
