            ...
            if not self.training:  # inference
                ...
                if self.inplace:
                    ...
                    if self.nkpt != 0:
                        ...
                        # logger.info('=============')
                        # logger.info(self.anchor_grid[i].shape)
                        # logger.info(self.anchor_grid[i][...,0].unsqueeze(4).shape)
                        # logger.info(x_kpt[..., 0::3].shape)
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(
        ...
        logger.info(
            "%3s%18s%3s%10.0f  %-40s%-30s" % (i, f, n, np, t, args)
        )  # logger.info
        save.extend(
...
if __name__ == "__main__":
    ...
    # logger.info("Run 'tensorboard --logdir=models/runs' to view tensorboard at http://localhost:6006/")
