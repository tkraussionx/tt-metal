...
run_tg_tests() {
  ...
  pytest models/demos/tg/llama3_70b/tests/test_llama_attention_galaxy.py -k prefill --timeout=480 ; fail+=$?
  pytest models/demos/tg/llama3_70b/tests/test_llama_decoder_galaxy.py --timeout=600 ; fail+=$?
