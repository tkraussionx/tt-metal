...
#     [[64, 1, 32, 32], [1, 1, 32, 32], [1, 1, 32, 32]],  # Single core
...
# @pytest.mark.parametrize("fn_kind", ["addcmul"])
...
shapes_w_output = [
    [[1, 1, 32, 32], [1, 1, 32, 32], [1, 1, 32, 32], [1, 1, 32, 32]],  # Single core
    # [[1, 1, 32, 32], [32, 1, 32, 32], [32, 1, 32, 32], [1, 1, 32, 32]],  # Single core
    # [[64, 1, 32, 32], [1, 1, 32, 32], [64, 1, 32, 32], [1, 1, 32, 32]],  # Single core
    # [[1, 1, 320, 384], [1, 1, 320, 384], [1, 1, 320, 384], [1, 1, 320, 384]],  # Multi core
    # [[1, 3, 320, 384], [1, 3, 320, 384], [1, 3, 320, 384], [1, 3, 320, 384]],  # Multi core
]
...
def test_run_addalpha_optional_output(
    ...
    test_args.update(
        {
            "input_mem_config": [input_mem_config, input_mem_config, input_mem_config, input_mem_config],
            "value": np.random.randint(1, 100),
            "queue_id": pass_qid,
        }
    )
