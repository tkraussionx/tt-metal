...
class TestEltwiseBinary:
    ...
    def test_run_eltwise_binary_ops(
        self, input_shapes, fn_kind, output_mem_config, device_id, function_level_defaults
    ):
        datagen_func = [
    ...
    def test_run_eltwise_binary_cmp_ops(
        self, input_shapes, output_mem_config, cmp_kind, device_id, function_level_defaults
    ):
        datagen_func = [
            generation_funcs.gen_func_with_cast(
