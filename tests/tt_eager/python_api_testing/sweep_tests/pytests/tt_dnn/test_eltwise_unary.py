...
class TestEltwiseUnary:
    ...
    def test_run_eltwise_unary_ops(
            self, input_shapes, fn_kind, device_id, function_level_defaults, output_mem_config
    ):
        datagen_func = [
    ...
    def test_run_eltwise_gelu_op(
        self, input_shapes, fast_and_appx, device_id, function_level_defaults, output_mem_config
    ):
        datagen_func = [
            generation_funcs.gen_func_with_cast(
                partial(generation_funcs.gen_rand, low=-100, high=100), torch.float32
    ...
    def test_run_eltwise_recip_op(
        self, input_shapes, device_id, function_level_defaults, output_mem_config
    ):
        datagen_func = [
            generation_funcs.gen_func_with_cast(
    ...
    def test_run_eltwise_cmp_ops(
        self, fn_kind, input_shapes, device_id, function_level_defaults, output_mem_config,
    ):
    ...
    def test_run_eltwise_log_ops(
        self, log_kind, range, input_shapes, device_id, function_level_defaults, output_mem_config,
    ):
        datagen_func = [
            generation_funcs.gen_func_with_cast(
                partial(
    ...
    def test_run_eltwise_periodic_trig_ops(
        self, input_shapes, trig_kind, device_id, function_level_defaults
        , output_mem_config
    ):
        datagen_func = [
            generation_funcs.gen_func_with_cast(
    ...
    def test_run_eltwise_power_op(
            self, input_shapes, input_value, exponent, device_id, function_level_defaults, output_mem_config
    ):
        datagen_func = [
            generation_funcs.gen_func_with_cast(
                partial(generation_funcs.gen_constant, constant=input_value),
    ...
    def test_run_eltwise_sign_ops(
        self, fn_kind, input_shapes, fill_val, device_id, function_level_defaults, output_mem_config,
    ):
    ...
    def test_run_eltwise_heaviside(
        self, input_shapes, value, device_id, function_level_defaults, output_mem_config,
    ):
        datagen_func = [
            generation_funcs.gen_func_with_cast(
    ...
    def test_run_eltwise_binop_to_unary_ops(
        self, unary_kind, input_shapes, device_id, scalar, function_level_defaults, output_mem_config,
    ):
        datagen_func = [
            generation_funcs.gen_func_with_cast(
                partial(generation_funcs.gen_rand, low=-100, high=100), torch.float32
    ...
    def test_run_eltwise_clip_ops(
        self, clip_kind, clip_range, input_shapes, device_id, function_level_defaults, output_mem_config
    ):
        datagen_func = [
            generation_funcs.gen_func_with_cast(
    ...
    def test_run_eltwise_elu_op(
        self, input_shapes, alpha, device_id, function_level_defaults, output_mem_config,
    ):
        datagen_func = [
            generation_funcs.gen_func_with_cast(
                partial(generation_funcs.gen_rand, low=-100, high=100), torch.float32
    ...
    def test_run_eltwise_leaky_relu_op(
        self, input_shapes, negative_slope, device_id, function_level_defaults, output_mem_config,
    ):
        datagen_func = [
            generation_funcs.gen_func_with_cast(
                partial(generation_funcs.gen_rand, low=-100, high=100), torch.float32
    ...
    def test_run_eltwise_arc_trig_ops(
        self, input_shapes, arc_trig_kind, device_id, function_level_defaults, output_mem_config
    ):
        datagen_func = [
            generation_funcs.gen_func_with_cast(
    ...
    def test_run_eltwise_erf_ops(
        self, input_shapes, fn_kind, fast_and_appx, device_id, function_level_defaults, output_mem_config,
    ):
        datagen_func = [
            generation_funcs.gen_func_with_cast(
                partial(generation_funcs.gen_rand, low=-100, high=100), torch.bfloat16
