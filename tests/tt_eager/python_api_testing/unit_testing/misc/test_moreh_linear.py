...
from tests.tt_eager.python_api_testing.unit_testing.misc.test_moreh_matmul import get_tensors, get_bias_tensors
...
def test_moreh_bias_backward_fp32(shapes, device):
    ...
    tt_input_grad_fp32, _, tt_bias_grad_fp32 = ttnn.experimental.operations.primary.moreh_linear_backward(
        tt_output_grad,
        tt_input,
        tt_weight,
        are_required_outputs=(requires_input_grad, requires_weight_grad, requires_bias_grad),
    ...
    tt_input_grad, _, tt_bias_grad = ttnn.experimental.operations.primary.moreh_linear_backward(
        tt_output_grad,
        tt_input,
        tt_weight,
        are_required_outputs=(requires_input_grad, requires_weight_grad, requires_bias_grad),
