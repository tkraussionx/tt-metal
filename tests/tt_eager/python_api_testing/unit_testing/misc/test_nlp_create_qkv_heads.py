...
"""
Generic shape + separte generation support
"""


def run_nlp_create_qkv_heads_separet_test(
    batch,
    seq_len,
    head_dim,
    num_q_heads,
    ...
    q = ttl.tensor.nlp_create_q_heads(
        in0_t,
        num_heads=num_q_heads,
        num_kv_heads=num_kv_heads,
        output_mem_config=out_mem_config,
    ...
    k, v = ttl.tensor.nlp_create_kv_heads(
        in0_t,
        num_heads=num_q_heads,
        num_kv_heads=num_kv_heads,
        transpose_k_heads=transpose_k_heads,
...
def test_nlp_create_qkv_heads_separate_test(
    batch,
    seq_len,
    head_dim,
    num_q_heads,
