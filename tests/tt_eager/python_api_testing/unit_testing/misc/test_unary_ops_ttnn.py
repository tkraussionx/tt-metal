...
# def test_unary_softplus_ttnn(input_shapes, beta, threshold, device):
#     in_data, input_tensor = data_gen_with_range(input_shapes, -1, 1, device)
#     _, output_tensor = data_gen_with_range(input_shapes, -1, 1, device)

#     cq_id = 0
#     ttnn.softplus(input_tensor, beta=beta, threshold=threshold, output_tensor=output_tensor, queue_id=cq_id)
#     golden_tensor = torch.nn.functional.softplus(in_data, beta, threshold)
