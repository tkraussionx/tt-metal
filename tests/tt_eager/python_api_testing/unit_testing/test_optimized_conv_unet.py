...
@pytest.mark.parametrize(
    ...
    (
        # unique convs (complete list)
        # the original batch size is 256
        (8, 16, 3, 1056, 160, 3, 3, 1, 1, 1, 1, True),
        (8, 16, 16, 1056, 160, 3, 3, 1, 1, 1, 1, True),
        (8, 16, 16, 528, 80, 3, 3, 1, 1, 1, 1, True),
        (8, 32, 16, 264, 40, 3, 3, 1, 1, 1, 1, True),
        (8, 32, 32, 264, 40, 3, 3, 1, 1, 1, 1, True),
        (8, 32, 32, 132, 20, 3, 3, 1, 1, 1, 1, True),
        (8, 64, 32, 66, 10, 3, 3, 1, 1, 1, 1, True),
        (8, 64, 64, 66, 10, 3, 3, 1, 1, 1, 1, True),
        (8, 32, 96, 132, 20, 3, 3, 1, 1, 1, 1, True),
        (8, 32, 32, 132, 20, 3, 3, 1, 1, 1, 1, True),
        (8, 32, 64, 264, 40, 3, 3, 1, 1, 1, 1, True),
        (8, 32, 32, 264, 40, 3, 3, 1, 1, 1, 1, True),
        (8, 16, 48, 528, 80, 3, 3, 1, 1, 1, 1, True),
        (8, 16, 16, 528, 80, 3, 3, 1, 1, 1, 1, True),
        (8, 16, 32, 1056, 160, 3, 3, 1, 1, 1, 1, True),
        (8, 16, 16, 1056, 160, 3, 3, 1, 1, 1, 1, True),
        (8, 1, 16, 1056, 160, 3, 3, 1, 1, 1, 1, True),
    ),
)
@pytest.mark.parametrize(
    "weights_dtype",
