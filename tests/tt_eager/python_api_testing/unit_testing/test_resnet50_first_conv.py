...
def test_resnet50_first_conv(use_program_cache, N, extra_padding_for_32B_alignment, device, untilize_out, has_bias, fuse_relu):
    ...
    for i in range(num_iterations):
        ...
        out = ttl.tensor.optimized_conv(
            ...
            ttl.tensor.OptimizedConvParallelizationConfig(grid_size=grid_size, per_core_out_matrix_height_ntiles=per_core_out_h_ntiles, per_core_weight_matrix_width_ntiles=per_core_weight_matrix_w_ntiles),
