...
TT_METAL_UNIT_TESTS_INCLUDES = $(TEST_INCLUDES) $(TT_METAL_INCLUDES) -I$(TT_METAL_HOME)/tests/tt_metal/tt_metal/gtest_unit_tests/common -I$(TT_METAL_HOME)/third_party/doctest
TT_METAL_UNIT_TESTS_LDFLAGS = -ltt_metal_impl -ltt_metal_detail -ltt_metal -lllrt -ldevice -lbuild_kernels_for_riscv -ldl -lcommon -lprofiler -lstdc++fs -pthread -lyaml-cpp -lgtest -ltracy
...
tests/tt_metal/gtest_unit_tests: $(TESTDIR)/tt_metal/gtest_unit_tests

.PRECIOUS: $(TESTDIR)/tt_metal/gtest_unit_tests
$(TESTDIR)/tt_metal/gtest_unit_tests: $(TT_METAL_UNIT_TESTS_OBJS) $(TT_METAL_LIB) $(TT_DNN_LIB)
	@mkdir -p $(@D)
