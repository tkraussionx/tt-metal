...
TT_METAL_UNIT_TESTS_SRCS_HOME = tests/tt_metal/tt_metal/gtest_unit_tests_cleanup
...
TT_METAL_UNIT_TESTS_OBJ_HOME = tt_metal/tests/gtest_unit_tests_cleanup/
TT_METAL_UNIT_TESTS_SRCS = $(patsubst $(TT_METAL_UNIT_TESTS_SRCS_HOME)%, $(TT_METAL_UNIT_TESTS_OBJ_HOME)%, $(TT_METAL_UNIT_TESTS))

TT_METAL_UNIT_TESTS_INCLUDES = $(TEST_INCLUDES) $(TT_METAL_INCLUDES) -I$(TT_METAL_HOME)/tests/tt_metal/tt_metal/gtest_unit_tests_cleanup/common -I$(TT_METAL_HOME)/third_party/doctest
...
tests/tt_metal/gtest_unit_tests_cleanup: $(TESTDIR)/tt_metal/gtest_unit_tests_cleanup

.PRECIOUS: $(TESTDIR)/tt_metal/gtest_unit_tests_cleanup
$(TESTDIR)/tt_metal/gtest_unit_tests_cleanup: $(TT_METAL_UNIT_TESTS_OBJS) $(TT_METAL_LIB) $(TT_DNN_LIB)
	@mkdir -p $(@D)
