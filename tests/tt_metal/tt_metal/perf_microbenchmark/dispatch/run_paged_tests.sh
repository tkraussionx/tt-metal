...
for TEST_ID in ${TEST_IDS[@]}; do
    ...
    #################################################################################
    # VARYING START_PAGE : CQDispatchWritePagedCmd.start_page                       #
    #################################################################################

    ${TT_METAL_HOME}/build/test/tt_metal/perf_microbenchmark/dispatch/test_dispatcher -i 1 -w 0 -t $TEST_ID -wx 0 -wy 1 -min 16 -max 16 -lps 4 -pbs 1 -np 1 -min-page 0 -max-page 0 -c |& tee ${DIR}/write_1_page_16b_size_dispatch_buffer_16b_pages_page0.log
    ${TT_METAL_HOME}/build/test/tt_metal/perf_microbenchmark/dispatch/test_dispatcher -i 1 -w 0 -t $TEST_ID -wx 0 -wy 1 -min 16 -max 16 -lps 4 -pbs 1 -np 1 -min-page 1 -max-page 1 -c |& tee ${DIR}/write_1_page_16b_size_dispatch_buffer_16b_pages_page1.log
    ${TT_METAL_HOME}/build/test/tt_metal/perf_microbenchmark/dispatch/test_dispatcher -i 1 -w 0 -t $TEST_ID -wx 0 -wy 1 -min 16 -max 16 -lps 4 -pbs 1 -np 1 -min-page 2 -max-page 2 -c |& tee ${DIR}/write_1_page_16b_size_dispatch_buffer_16b_pages_page2.log
    ${TT_METAL_HOME}/build/test/tt_metal/perf_microbenchmark/dispatch/test_dispatcher -i 1 -w 0 -t $TEST_ID -wx 0 -wy 1 -min 16 -max 16 -lps 4 -pbs 1 -np 1 -min-page 12 -max-page 12 -c |& tee ${DIR}/write_1_page_16b_size_dispatch_buffer_16b_pages_page12.log
