...
int main(int argc, char **argv) {
    ...
    uint32_t data_kb_per_tx = test_args::get_command_option_uint32(input_args, "--data_kb_per_tx", data_kb_per_tx);
            ...
            std::vector<uint32_t> compile_args =
                {
                    ...
                    data_kb_per_tx*num_src_endpoints/num_dest_endpoints, // 12: total_data_kb
        ...
        std::vector<uint32_t> demux_compile_args =
            {
                ...
                (rx_queue_start_addr >> 4), // 1: rx_queue_start_addr_words
                (rx_queue_size_bytes >> 4), // 2: rx_queue_size_words
                ...
                (uint32_t)mux_phys_core.x, // 16: remote_tx_x
                (uint32_t)mux_phys_core.y, // 17: remote_tx_y
                0, // 18: remote_tx_queue_id
