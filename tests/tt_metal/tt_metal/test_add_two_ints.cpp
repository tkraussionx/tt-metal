...
int main(int argc, char **argv) {
    ...
    try {
        ...
        tt_metal::detail::ReadFromDeviceL1(device, core, BRISC_L1_ARG_BASE_BUF0 + RUNTIME_ARG_BUFFER_SIZE, sizeof(int), first_kernel_result);
        ...
        tt_metal::detail::ReadFromDeviceL1(device, core, BRISC_L1_ARG_BASE_BUF0 + RUNTIME_ARG_BUFFER_SIZE, sizeof(int), second_kernel_result);
