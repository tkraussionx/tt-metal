...
void MAIN {
    ...
    UNPACK(arg_a_ptr[0] = arg_a + 100);
    UNPACK(arg_b_ptr[0] = arg_b + 200);
    UNPACK(common_arg_a_ptr[0] = common_arg_a + 10);
    UNPACK(common_arg_b_ptr[0] = common_arg_b + 20);
    UNPACK(common_arg_c_ptr[0] = common_arg_c + 30);
    UNPACK(common_arg_d_ptr[0] = common_arg_d + 40);
