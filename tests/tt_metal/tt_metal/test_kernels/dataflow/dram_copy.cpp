...
#endif
        uint64_t dispatch_addr = NOC_XY_ADDR(NOC_X(mailboxes->launch[maiboxes->launch_msg_rd_ptr].kernel_config.dispatch_core_x),
                                             NOC_Y(mailboxes->launch[maiboxes->launch_msg_rd_ptr].kernel_config.dispatch_core_y), DISPATCH_MESSAGE_ADDR);
