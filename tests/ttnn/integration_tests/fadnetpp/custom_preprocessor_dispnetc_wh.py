...
from models.experimental.functional_fadnetpp.reference.dispnetc_wh import DispNetC
import ttnn
from ttnn.model_preprocessing import preprocess_conv2d, fold_batch_norm2d_into_conv2d
...
def custom_preprocessor(device, model, name, ttnn_module_args, resblock=True):
    ...
    if isinstance(model, DispNetC):
        ...
        if resblock:
            ...
            # )
            parameters["extractnet"]["conv2"]["resblock_1_conv1"] = {}
            parameters["extractnet"]["conv2"]["resblock_1_conv1"]["weight"] = weight1
            parameters["extractnet"]["conv2"]["resblock_1_conv1"]["bias"] = bias1
            ...
            #     return_parallel_config=True,
            # )
            parameters["extractnet"]["conv2"]["resblock_2_conv2"] = {}
            parameters["extractnet"]["conv2"]["resblock_2_conv2"]["weight"] = weight2
            parameters["extractnet"]["conv2"]["resblock_2_conv2"]["bias"] = bias2
            ...
            #     return_parallel_config=True,
            # )
            parameters["extractnet"]["conv2"]["resblock_sc_conv"] = {}
            parameters["extractnet"]["conv2"]["resblock_sc_conv"]["weight"] = weight3
            parameters["extractnet"]["conv2"]["resblock_sc_conv"]["bias"] = bias3
            ...
            #     return_parallel_config=True,
            # )
            parameters["extractnet"]["conv3"]["resblock_1_conv1"] = {}
            parameters["extractnet"]["conv3"]["resblock_1_conv1"]["weight"] = weight1
            parameters["extractnet"]["conv3"]["resblock_1_conv1"]["bias"] = bias1
            ...
            #     return_parallel_config=True,
            # )
            parameters["extractnet"]["conv3"]["resblock_2_conv2"] = {}
            parameters["extractnet"]["conv3"]["resblock_2_conv2"]["weight"] = weight2
            parameters["extractnet"]["conv3"]["resblock_2_conv2"]["bias"] = bias2
            ...
            #     return_parallel_config=True,
            # )
            parameters["extractnet"]["conv3"]["resblock_sc_conv"] = {}
            parameters["extractnet"]["conv3"]["resblock_sc_conv"]["weight"] = weight3
            parameters["extractnet"]["conv3"]["resblock_sc_conv"]["bias"] = bias3
        ...
        if resblock:
            ...
            #     return_parallel_config=True,
            # )
            parameters["cunet"]["conv_redir"]["resblock_1_conv1"] = {}
            parameters["cunet"]["conv_redir"]["resblock_1_conv1"]["weight"] = weight1
            parameters["cunet"]["conv_redir"]["resblock_1_conv1"]["bias"] = bias1
            ...
            #     return_parallel_config=True,
            # )
            parameters["cunet"]["conv_redir"]["resblock_2_conv2"] = {}
            parameters["cunet"]["conv_redir"]["resblock_2_conv2"]["weight"] = weight1
            parameters["cunet"]["conv_redir"]["resblock_2_conv2"]["bias"] = bias1
            ...
            #     return_parallel_config=True,
            # )
            parameters["cunet"]["conv_redir"]["resblock_sc_conv"] = {}
            parameters["cunet"]["conv_redir"]["resblock_sc_conv"]["weight"] = weight1
            parameters["cunet"]["conv_redir"]["resblock_sc_conv"]["bias"] = bias1
            ...
            # )
            parameters["cunet"]["conv4"]["resblock_1_conv1"] = {}
            parameters["cunet"]["conv4"]["resblock_1_conv1"]["weight"] = weight1
            parameters["cunet"]["conv4"]["resblock_1_conv1"]["bias"] = bias1
            ...
            # )
            parameters["cunet"]["conv4"]["resblock_2_conv2"] = {}
            parameters["cunet"]["conv4"]["resblock_2_conv2"]["weight"] = weight1
            parameters["cunet"]["conv4"]["resblock_2_conv2"]["bias"] = bias1
            ...
            # )
            parameters["cunet"]["conv4"]["resblock_sc_conv"] = {}
            parameters["cunet"]["conv4"]["resblock_sc_conv"]["weight"] = weight1
            parameters["cunet"]["conv4"]["resblock_sc_conv"]["bias"] = bias1
            ...
            #     return_parallel_config=True,
            # )
            parameters["cunet"]["conv4_1"]["resblock_1_conv1"] = {}
            parameters["cunet"]["conv4_1"]["resblock_1_conv1"]["weight"] = weight1
            parameters["cunet"]["conv4_1"]["resblock_1_conv1"]["bias"] = bias1
            ...
            #     return_parallel_config=True,
            # )
            parameters["cunet"]["conv4_1"]["resblock_2_conv2"] = {}
            parameters["cunet"]["conv4_1"]["resblock_2_conv2"]["weight"] = weight1
            parameters["cunet"]["conv4_1"]["resblock_2_conv2"]["bias"] = bias1
            ...
            # )
            parameters["cunet"]["conv5"]["resblock_1_conv1"] = {}
            parameters["cunet"]["conv5"]["resblock_1_conv1"]["weight"] = weight1
            parameters["cunet"]["conv5"]["resblock_1_conv1"]["bias"] = bias1
            ...
            # )
            parameters["cunet"]["conv5"]["resblock_2_conv2"] = {}
            parameters["cunet"]["conv5"]["resblock_2_conv2"]["weight"] = weight1
            parameters["cunet"]["conv5"]["resblock_2_conv2"]["bias"] = bias1
            ...
            # )
            parameters["cunet"]["conv5"]["resblock_sc_conv"] = {}
            parameters["cunet"]["conv5"]["resblock_sc_conv"]["weight"] = weight1
            parameters["cunet"]["conv5"]["resblock_sc_conv"]["bias"] = bias1
            ...
            #     return_parallel_config=True,
            # )
            parameters["cunet"]["conv5_1"]["resblock_1_conv1"] = {}
            parameters["cunet"]["conv5_1"]["resblock_1_conv1"]["weight"] = weight1
            parameters["cunet"]["conv5_1"]["resblock_1_conv1"]["bias"] = bias1
            ...
            #     return_parallel_config=True,
            # )
            parameters["cunet"]["conv5_1"]["resblock_2_conv2"] = {}
            parameters["cunet"]["conv5_1"]["resblock_2_conv2"]["weight"] = weight1
            parameters["cunet"]["conv5_1"]["resblock_2_conv2"]["bias"] = bias1
            ...
            # )
            parameters["cunet"]["conv6"]["resblock_1_conv1"] = {}
            parameters["cunet"]["conv6"]["resblock_1_conv1"]["weight"] = weight1
            parameters["cunet"]["conv6"]["resblock_1_conv1"]["bias"] = bias1
            ...
            # )
            parameters["cunet"]["conv6"]["resblock_2_conv2"] = {}
            parameters["cunet"]["conv6"]["resblock_2_conv2"]["weight"] = weight1
            parameters["cunet"]["conv6"]["resblock_2_conv2"]["bias"] = bias1
            ...
            # )
            parameters["cunet"]["conv6"]["resblock_sc_conv"] = {}
            parameters["cunet"]["conv6"]["resblock_sc_conv"]["weight"] = weight1
            parameters["cunet"]["conv6"]["resblock_sc_conv"]["bias"] = bias1
            ...
            #     return_parallel_config=True,
            # )
            parameters["cunet"]["conv6_1"]["resblock_1_conv1"] = {}
            parameters["cunet"]["conv6_1"]["resblock_1_conv1"]["weight"] = weight1
            parameters["cunet"]["conv6_1"]["resblock_1_conv1"]["bias"] = bias1
            ...
            #     return_parallel_config=True,
            # )
            parameters["cunet"]["conv6_1"]["resblock_2_conv2"] = {}
            parameters["cunet"]["conv6_1"]["resblock_2_conv2"]["weight"] = weight1
            parameters["cunet"]["conv6_1"]["resblock_2_conv2"]["bias"] = bias1
