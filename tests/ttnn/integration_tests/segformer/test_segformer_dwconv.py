...
@pytest.mark.parametrize(
    ...
    [
        # (1, 16384, 128, 128, 128, 0, 0), # PCC drop
        # (1, 16384, 128, 128, 128, 0, 1), # PCC drop
        # (1, 4096, 256, 64, 64, 1, 0), # PCC drop
        # (1, 4096, 256, 64, 64, 1, 1), # PCC drop
        # (1, 1024, 640, 32, 32, 2, 0), # PCC drop
        # (1, 1024, 640, 32, 32, 2, 1), # PCC drop
