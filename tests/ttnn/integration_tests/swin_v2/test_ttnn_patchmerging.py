...
from models.experimental.functional_swin_v2.reference.patchmerging_v2 import PatchMergingV2
from models.experimental.functional_swin_v2.tt.tt_patchmerging import TtPatchMerging
