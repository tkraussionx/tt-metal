...
from models.experimental.functional_swin_v2.reference.swin_transformer_block_v2 import SwinTransformerBlockV2
from models.experimental.functional_swin_v2.tt.tt_swin_transformer_block import TtSwinTransformerBlock
...
def test_shifted_window_attention(device, reset_seeds):
    ...
    torch_model = SwinTransformerBlockV2(192, 6, [7, 7], [0, 0])
