...
from models.experimental.functional_swin_v2.reference.swin_transformer_v2 import SwinTransformerV2
from models.experimental.functional_swin_v2.tt.tt_swin_transformer import TtSwinTransformer
...
def test_patchmerging(device, reset_seeds):
    ...
    ds_state_dict = model.state_dict()

    torch_model = SwinTransformerV2(
        patch_size=[4, 4],
        embed_dim=96,
        depths=[2, 2, 6, 2],
        num_heads=[3, 6, 12, 24],
