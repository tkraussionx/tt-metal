...
def create_custom_preprocessor(device, groups=1, act_block_n=1):
...
def test_unet(device, loop, perf_mode, groups):
    ...
    with torch.no_grad():
        ...
        parameters = preprocess_model(
            ...
            custom_preprocessor=create_custom_preprocessor(device, groups=groups, act_block_n=5),
    ...
    with torch.no_grad():
        ...
        parameters = preprocess_model(
            ...
            custom_preprocessor=create_custom_preprocessor(
                device, groups=groups, act_block_n=8
