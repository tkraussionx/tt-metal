...
test_sweep_args = [
    (
        ...
        [ttnn.TILE_LAYOUT],
        [None, ttnn.DRAM_MEMORY_CONFIG, ttnn.L1_MEMORY_CONFIG],
        (None),
        16305027,
        -90.0,
    ),
    (
        ...
        [ttnn.TILE_LAYOUT],
        [ttnn.L1_MEMORY_CONFIG, None, ttnn.L1_MEMORY_CONFIG],
        (None),
        12915139,
        -23.5,
    ),
    (
        [(4, 8, 192, 192)],
        [ttnn.bfloat8_b, ttnn.bfloat16, ttnn.bfloat8_b],
        [ttnn.TILE_LAYOUT],
        [ttnn.L1_MEMORY_CONFIG, ttnn.DRAM_MEMORY_CONFIG, None],
