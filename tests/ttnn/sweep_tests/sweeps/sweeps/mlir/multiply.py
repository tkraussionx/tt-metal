...
def run(
    ...
    *,
    ...
    torch_input_tensor_a = torch_random(input_shape_a, -3.14, 3.14, dtype=torch.float32)
    torch_input_tensor_b = torch_random(input_shape_b, -3.14, 3.14, dtype=torch.float32)
    torch_output_tensor = torch.multiply(torch_input_tensor_a, torch_input_tensor_b)
