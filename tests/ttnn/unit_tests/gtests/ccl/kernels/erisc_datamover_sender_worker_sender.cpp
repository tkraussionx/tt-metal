...
void kernel_main() {
    ...
    const ttnn::ccl::EriscDataMoverPacketSizingMode packet_sizing_mode =
        static_cast<ttnn::ccl::EriscDataMoverPacketSizingMode>(get_compile_time_arg_val(5));
