...
int TestEntrypoint(
    ...
    if (num_devices < 2) {
        log_info("Need at least 2 devices to run this test");
        return 0;
    }
...
TEST(WorkerEdmDatapath, MergedPayloadAndSignal_1ChannelForward_0ChannelsReverse_1BufferPerChannel_2048PageSize_100kPages_MessageCountTermination) {
...
TEST(WorkerEdmDatapath, MergedPayloadAndSignal_1ChannelForward_1ChannelsReverse_1BufferPerChannel_2048PageSize_100kPages_MessageCountTermination) {
    const uint32_t num_local_sender_channels = 1;
...
TEST(WorkerEdmDatapath, MergedPayloadAndSignal_0ChannelForward_1ChannelsReverse_2BufferPerChannel_2048PageSize_100kPages_MessageCountTermination) {
...
TEST(WorkerEdmDatapath, MergedPayloadAndSignal_1ChannelForward_0ChannelsReverse_2BufferPerChannel_2048PageSize_100kPages_MessageCountTermination) {
    const uint32_t num_local_sender_channels = 1;
    const uint32_t num_remote_sender_channels = 0;
    const uint32_t num_buffers_per_edm_channel = 2;
    const uint32_t page_size = 2048;
...
TEST(WorkerEdmDatapath, MergedPayloadAndSignal_1ChannelForward_1ChannelsReverse_2BufferPerChannel_2048PageSize_100kPages_MessageCountTermination) {
    const uint32_t num_local_sender_channels = 1;
    const uint32_t num_remote_sender_channels = 1;
    const uint32_t num_buffers_per_edm_channel = 2;
    const uint32_t page_size = 2048;
...
TEST(WorkerEdmDatapath, MergedPayloadAndSignal_1ChannelForward_0ChannelsReverse_3BufferPerChannel_2048PageSize_100kPages_MessageCountTermination) {
    const uint32_t num_local_sender_channels = 1;
    const uint32_t num_remote_sender_channels = 0;
...
TEST(WorkerEdmDatapath, MergedPayloadAndSignal_2ChannelForward_2ChannelsReverse_2BufferPerChannel_2048PageSize_100kPages_MessageCountTermination) {
...
TEST(WorkerEdmDatapath, MergedPayloadAndSignal_4ChannelForward_4ChannelsReverse_1BufferPerChannel_2048PageSize_100kPages_MessageCountTermination) {
...
TEST(WorkerEdmDatapath, MergedPayloadAndSignal_4ChannelForward_4ChannelsReverse_2BufferPerChannel_2048PageSize_100kPages_MessageCountTermination) {
    const uint32_t num_local_sender_channels = 4;
    const uint32_t num_remote_sender_channels = 4;
    const uint32_t num_buffers_per_edm_channel = 2;
    const uint32_t page_size = 2048;
...
TEST(WorkerEdmDatapath, MergedPayloadAndSignal_1ChannelForward_0ChannelsReverse_1BufferPerChannel_2048PageSize_100kPages_WorkerInitiatedTermination) {
    const uint32_t num_local_sender_channels = 1;
    const uint32_t num_remote_sender_channels = 0;
    const uint32_t num_buffers_per_edm_channel = 1;
    const uint32_t page_size = 2048;
...
TEST(WorkerEdmDatapath, MergedPayloadAndSignal_1ChannelForward_1ChannelsReverse_1BufferPerChannel_2048PageSize_100kPages_WorkerInitiatedTermination) {
    const uint32_t num_local_sender_channels = 1;
    const uint32_t num_remote_sender_channels = 1;
    const uint32_t num_buffers_per_edm_channel = 1;
    const uint32_t page_size = 2048;
...
TEST(WorkerEdmDatapath, MergedPayloadAndSignal_1ChannelForward_0ChannelsReverse_2BufferPerChannel_2048PageSize_100kPages_WorkerInitiatedTermination) {
    const uint32_t num_local_sender_channels = 1;
    const uint32_t num_remote_sender_channels = 0;
    const uint32_t num_buffers_per_edm_channel = 2;
    const uint32_t page_size = 2048;
...
TEST(WorkerEdmDatapath, MergedPayloadAndSignal_1ChannelForward_0ChannelsReverse_3BufferPerChannel_2048PageSize_100kPages_WorkerInitiatedTermination) {
    const uint32_t num_local_sender_channels = 1;
    const uint32_t num_remote_sender_channels = 0;
    const uint32_t num_buffers_per_edm_channel = 3;
    const uint32_t page_size = 2048;
...
TEST(WorkerEdmDatapath, MergedPayloadAndSignal_1ChannelForward_1ChannelsReverse_2BufferPerChannel_2048PageSize_100kPages_WorkerInitiatedTermination) {
    const uint32_t num_local_sender_channels = 1;
    const uint32_t num_remote_sender_channels = 1;
    const uint32_t num_buffers_per_edm_channel = 2;
    const uint32_t page_size = 2048;
