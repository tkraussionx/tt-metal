...
@pytest.mark.parametrize(
    ...
    (
        ...
        (1, 32, 32, 480, 640, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 32, 32, 480, 640, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 32
        (1, 32, 32, 480, 640, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 32, 64, 480, 640, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 64, 32, 480, 640, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 128, 64, 480, 640, 3, 3, 1, 1, 1, 1, True, None, False),  # groups: 1
        (1, 64, 128, 480, 640, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 64, 64, 480, 640, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 64
        (1, 64, 64, 480, 640, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 64, 64, 480, 640, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 64
        (1, 64, 64, 480, 640, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 64, 128, 480, 640, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 128, 64, 480, 640, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 64, 128, 480, 640, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 64, 64, 480, 640, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 64
        (1, 64, 64, 480, 640, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 64, 64, 480, 640, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 64
        ...
        (1, 64, 128, 480, 640, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 128, 64, 480, 640, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 256, 128, 480, 640, 3, 3, 2, 2, 1, 1, True, None, False),  # groups: 1
        (1, 128, 256, 240, 320, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 128, 128, 240, 320, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 128
        (1, 128, 128, 240, 320, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 128, 128, 240, 320, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 128
        (1, 128, 128, 240, 320, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 128, 256, 240, 320, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 256, 128, 240, 320, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 128, 256, 240, 320, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 128, 128, 240, 320, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 128
        (1, 128, 128, 240, 320, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 128, 128, 240, 320, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 128
        ...
        (1, 128, 256, 240, 320, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 256, 128, 240, 320, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 512, 256, 240, 320, 3, 3, 2, 2, 1, 1, True, None, False),  # groups: 1
        (1, 256, 512, 120, 160, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 256, 256, 120, 160, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 256
        (1, 256, 256, 120, 160, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 256, 256, 120, 160, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 256
        (1, 256, 256, 120, 160, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 256, 512, 120, 160, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 512, 256, 120, 160, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 256, 512, 120, 160, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 256, 256, 120, 160, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 256
        (1, 256, 256, 120, 160, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 256, 256, 120, 160, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 256
        ...
        (1, 256, 512, 120, 160, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 512, 256, 120, 160, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 1024, 512, 120, 160, 3, 3, 2, 2, 1, 1, True, None, False),  # groups: 1
        (1, 512, 1024, 60, 80, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 512, 512, 60, 80, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 512
        (1, 512, 512, 60, 80, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 512, 512, 60, 80, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 512
        (1, 512, 512, 60, 80, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 512, 1024, 60, 80, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 1024, 512, 60, 80, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 512, 1024, 60, 80, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 512, 512, 60, 80, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 512
        (1, 512, 512, 60, 80, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        # (1, 512, 512, 60, 80, 3, 3, 1, 1, 1, 1, True, None, False) , # groups: 512
        ...
        (1, 1024, 512, 60, 80, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 512, 1024, 60, 80, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 1024, 512, 60, 80, 3, 3, 1, 1, 1, 1, True, None, False),  # groups: 1
        (1, 512, 1024, 60, 80, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
        (1, 255, 512, 60, 80, 1, 1, 1, 1, 0, 0, True, None, False),  # groups: 1
    ),
)
@pytest.mark.parametrize(
    "weights_dtype",
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            None,
            False,
        ),  # use block sharding to pass/ fails via height sharding
        (
            1,
            512,
            512,
