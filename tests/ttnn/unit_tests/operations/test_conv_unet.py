...
@pytest.mark.parametrize(
    ...
    (
        ...
        (16, 3, 1056, 160, 3, 3, 1, 1, 1, 1, True),
        (16, 16, 1056, 160, 3, 3, 1, 1, 1, 1, True),
        (16, 16, 528, 80, 3, 3, 1, 1, 1, 1, True),
        (32, 16, 264, 40, 3, 3, 1, 1, 1, 1, True),
        (32, 32, 264, 40, 3, 3, 1, 1, 1, 1, True),
        (32, 32, 132, 20, 3, 3, 1, 1, 1, 1, True),
        (64, 32, 66, 10, 3, 3, 1, 1, 1, 1, True),
        (64, 64, 66, 10, 3, 3, 1, 1, 1, 1, True),
        (32, 96, 132, 20, 3, 3, 1, 1, 1, 1, True),
        (32, 32, 132, 20, 3, 3, 1, 1, 1, 1, True),
        (32, 64, 264, 40, 3, 3, 1, 1, 1, 1, True),
        (32, 32, 264, 40, 3, 3, 1, 1, 1, 1, True),
        (16, 48, 528, 80, 3, 3, 1, 1, 1, 1, True),
        (16, 16, 528, 80, 3, 3, 1, 1, 1, 1, True),
        (16, 32, 1056, 160, 3, 3, 1, 1, 1, 1, True),
        (16, 16, 1056, 160, 3, 3, 1, 1, 1, 1, True),
        (1, 16, 1056, 160, 3, 3, 1, 1, 1, 1, True),
    ),
)
@pytest.mark.parametrize(
    "batch_size",
    [4, 8],
    ids=["batch_size_4", "batch_size_8"],
)
@pytest.mark.parametrize(
    "weights_dtype",
