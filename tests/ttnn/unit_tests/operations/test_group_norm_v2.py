...
def test_group_norm_with_block_sharded_v2_8x4_grid(device, N, C, H, W, num_groups):
    ...
    print(sharded_mem_config.memory_layout == ttnn.types.TensorMemoryLayout.BLOCK_SHARDED)
...
#     "N, C, H, W, num_groups",
#     [
#         # (1, 320, 1, 8192, 32), # cannot test due to address alignment for now
#         (1, 640, 1, 2048, 32),
#         (1, 640, 1, 4096, 32),
#         # (1, 960, 1, 2048, 32),    # cannot test due to address alignment for now
#         # (1, 960, 1, 4096, 32),    # cannot test due to address alignment for now
#         (1, 1280, 1, 512, 32),
#         (1, 1280, 1, 2048, 32),
#         (1, 1920, 1, 512, 32),
#         (1, 1920, 1, 2048, 32),
