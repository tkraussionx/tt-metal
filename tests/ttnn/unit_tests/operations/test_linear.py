...
@pytest.mark.parametrize(
    "batch_sizes, k_size, n_size, use_bias",
    (
        ((32,), 1024, 512, True),  # Passed
        ((32,), 512, 256, True),  # Passed
        ((32,), 256, 9, True),  # Passed
    ),
)
def test_pointnet_linear(
    batch_sizes,
    k_size,
    n_size,
    use_bias,
    *,
    ...
    input_shape_a = (*batch_sizes, k_size)
    input_shape_b = (k_size, n_size)
