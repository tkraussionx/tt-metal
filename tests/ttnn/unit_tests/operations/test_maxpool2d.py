...
@pytest.mark.parametrize(
    ...
    (
        (
            ...
            [1, 64, 1018, 122],  # Passed in Bfloat16, Fails in Bfloat8_b
            [1, 64, 506, 58],  # Passed in Bfloat16, Fails in Bfloat8_b
        )
    ),
)
@pytest.mark.parametrize(
...
def test_model_net_max_pool_4094x510(
    ...
    # assert_with_pcc(out_pytorch, golden_pytorch, 0.99)
...
@pytest.mark.parametrize(
    ...
    (
        (
            ...
            [1, 64, 1019, 123],  # Passed in Bfloat16, Fails in Bfloat8_b
            [1, 64, 506, 58],  # Passed in Bfloat16, Fails in Bfloat8_b
            [1, 64, 250, 26],  # Passed in Bfloat16, Fails in Bfloat8_b
        )
    ),
)
@pytest.mark.parametrize(
