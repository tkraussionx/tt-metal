...
@pytest.mark.parametrize(
    ...
    (
        ...
        (1, 32, 16, 64, 64, 1, 1, 1, 1, 0, 0, 1, True, None, False),
        (1, 96, 96, 64, 64, 3, 3, 2, 2, 0, 0, 96, True, None, False),
        (1, 96, 24, 32, 32, 1, 1, 1, 1, 0, 0, 1, True, None, False),
...
@pytest.mark.parametrize("math_fidelity", [ttnn.MathFidelity.LoFi])
@pytest.mark.parametrize("output_layout", [ttnn.TILE_LAYOUT])
def test_conv_mobilenetv2_low_pcc(
    device,
    use_program_cache,
    math_fidelity,
    activations_dtype,
...
@pytest.mark.parametrize("math_fidelity", [ttnn.MathFidelity.LoFi])
@pytest.mark.parametrize("output_layout", [ttnn.TILE_LAYOUT])
def test_conv_mobilenetv2_matmul_issue(
    device,
    use_program_cache,
    math_fidelity,
    activations_dtype,
...
@pytest.mark.parametrize("math_fidelity", [ttnn.MathFidelity.LoFi])
@pytest.mark.parametrize("output_layout", [ttnn.TILE_LAYOUT])
def test_conv_mobilenetv2_bias_issue(
    device,
    use_program_cache,
    math_fidelity,
    activations_dtype,
