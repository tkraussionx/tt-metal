...
@pytest.mark.parametrize(
    ...
    (
        ...
        (1, 144, 32, 32, 32, 1, 1, 1, 1, 0, 0, True, None),  # shape issue, 144 are zero padded to 160
        (1, 144, 16, 32, 32, 1, 1, 1, 1, 0, 0, True, None),  # sharding shape error
        (1, 144, 24, 32, 32, 1, 1, 1, 1, 0, 0, True, None),  # width/height issue
        (1, 144, 48, 32, 32, 1, 1, 1, 1, 0, 0, True, None),  # width/height issue
        (1, 144, 30, 32, 32, 1, 1, 1, 1, 0, 0, True, None),  # width/height issue
        (1, 144, 32, 32, 32, 1, 1, 1, 1, 0, 0, True, None),  # shape issue
        (1, 112, 32, 32, 32, 1, 1, 1, 1, 0, 0, True, None),  # shape issue
        (1, 176, 32, 32, 32, 1, 1, 1, 1, 0, 0, True, None),  # shape issue
        (1, 196, 32, 32, 32, 1, 1, 1, 1, 0, 0, True, None),  # shape issue
    ),
)
@pytest.mark.parametrize(
    "weights_dtype",
