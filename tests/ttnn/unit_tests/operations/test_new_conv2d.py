...
@pytest.mark.parametrize(
    "batch_size, output_channels,input_channels, input_height, input_width, filter_height, filter_width, stride_h, stride_w, pad_h, pad_w, use_1d_systolic_array, config_override, use_shallow_conv_variant,groups",
    (
        (1, 16, 3, 224, 224, 3, 3, 2, 2, 1, 1, True, None, False, 1),
        (1, 16, 16, 112, 112, 3, 3, 2, 2, 1, 1, True, None, False, 16),
        (1, 8, 16, 1, 1, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 16, 8, 1, 1, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 16, 16, 56, 56, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 72, 16, 56, 56, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 72, 72, 56, 56, 3, 3, 2, 2, 1, 1, True, None, False, 72),
        (1, 24, 72, 28, 28, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 88, 24, 28, 28, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 88, 88, 28, 28, 3, 3, 1, 1, 1, 1, True, None, False, 88),
        (1, 24, 88, 28, 28, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 96, 24, 28, 28, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 96, 96, 28, 28, 5, 5, 2, 2, 2, 2, True, None, False, 96),
        (1, 24, 96, 1, 1, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 96, 24, 1, 1, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 40, 96, 14, 14, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 240, 40, 14, 14, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 240, 240, 14, 14, 5, 5, 1, 1, 2, 2, True, None, False, 240),
        (1, 64, 240, 1, 1, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 240, 64, 1, 1, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 40, 240, 14, 14, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 120, 40, 14, 14, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 120, 120, 14, 14, 5, 5, 1, 1, 2, 2, True, None, False, 120),
        (1, 32, 120, 1, 1, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 120, 32, 1, 1, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 48, 120, 14, 14, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 144, 48, 14, 14, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 144, 144, 14, 14, 5, 5, 1, 1, 2, 2, True, None, False, 144),
        (1, 40, 144, 1, 1, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 144, 40, 1, 1, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 48, 144, 14, 14, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 288, 48, 14, 14, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 288, 288, 14, 14, 5, 5, 2, 2, 2, 2, True, None, False, 288),
        (1, 72, 288, 1, 1, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 288, 72, 1, 1, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 96, 288, 7, 7, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 576, 96, 7, 7, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 144, 576, 1, 1, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 576, 144, 1, 1, 1, 1, 1, 1, 0, 0, True, None, False, 1),
        (1, 96, 576, 7, 7, 1, 1, 1, 1, 0, 0, True, None, False, 1),
    ),
)
@pytest.mark.parametrize(
    "weights_dtype",
...
@pytest.mark.parametrize("device_params", [{"l1_small_size": 16384}], indirect=True)
@pytest.mark.parametrize(
    "output_channels, input_channels, input_height, input_width, filter_height, filter_width,stride_h,stride_w, pad_h, pad_w, act_block_w_div,groups",
    ((576, 576, 7, 7, 5, 5, 2, 2, 1, 1, 1, 576),),
)
@pytest.mark.parametrize(
    "has_bias",
    [True],
