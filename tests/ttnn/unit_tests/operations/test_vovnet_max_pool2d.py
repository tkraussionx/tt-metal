...
@pytest.mark.parametrize(
    ...
    (
        (
            # VoVNet maxpool inputs with ceil_mode true
            [1, 64, 56, 56],
            [1, 256, 56, 56],
            [1, 512, 28, 28],
            [1, 768, 14, 14],
...
# Run the test with : pytest tests/ttnn/unit_tests/operations/test_vovnet_max_pool2d.py::test_run_vovnet_max_pool
# When ceil_mode is set to true in torch op,

#   Case 1: Input shape : [1, 64, 56, 56]
#   Expected output shape / Torch output shape: [1, 64, 28, 28]
#   Ttnn output shape : [1, 1, 729, 64] i.e., [1, 1, 27*27, 64]

#   Case 2: Input shape : [1, 256, 56, 56]
#   Expected output shape / Torch output shape: [1, 256, 28, 28]
#   Ttnn output shape : [1, 1, 729, 256] i.e., [1, 1, 27*27, 256]

#   Case 3: Input shape : [1, 512, 28, 28]
#   Expected output shape / Torch output shape: [1, 512, 14, 14]
#   Ttnn output shape : [1, 1, 169, 512] i.e., [1, 1, 13*13, 512]

#   Case 4: Input shape : [1, 768, 14, 14]
#   Expected output shape / Torch output shape: [1, 768, 7, 7]
#   Ttnn - Fails with "Row size (nchannels * bytes = 1536) should be power of 2 (false)."
