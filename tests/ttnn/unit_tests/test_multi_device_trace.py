...
def test_multi_device_single_trace_single_cq(t3k_mesh_device, shape, use_all_gather, enable_async):
...
def test_multi_device_multi_trace_single_cq(t3k_mesh_device, shape, use_all_gather, enable_async):
    torch.manual_seed(0)
    if t3k_mesh_device.get_num_devices() <= 1:
        pytest.skip("This test requires multiple devices")
