...
def test_multi_device_single_trace(t3k_device_mesh, shape, use_all_gather):
    import time
    ...
    for i in range(50):
        ...
        ttl.device.Synchronize(t3k_device_mesh.get_device(0))
        ttl.device.Synchronize(t3k_device_mesh.get_device(4))
