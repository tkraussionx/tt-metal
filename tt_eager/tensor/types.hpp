...
struct MultiDeviceHostStorage {
        ...
        MultiDeviceHostStorage(DistributionStrategy strategy_, std::vector<OwnedBuffer> buffers_, std::vector<Shape> shapes_) : strategy(strategy_), buffers(buffers_), shapes(shapes_) {}
    ...
    struct MultiDeviceStorage {
        ...
        MultiDeviceStorage(DistributionStrategy strategy_, std::unordered_map<int, DeviceBuffer> buffers_, std::unordered_map<int, Shape> shapes_) : strategy(strategy_), buffers(buffers_), shapes(shapes_) {}
