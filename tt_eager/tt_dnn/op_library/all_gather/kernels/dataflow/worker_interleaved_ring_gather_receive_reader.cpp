...
void kernel_main() {
    ...
    // DPRINT << "rwr " << ID << " START: " << num_transfers << " transfers\n";
    // DPRINT << "rwr " << ID << " num_full_chunks: " << num_full_chunks << " transfers\n";
    // DPRINT << "rwr " << ID << " rem_num_pages: " << rem_num_pages << " transfers\n";
    // DPRINT << "rwr " << ID << " computed total_num_transfers: " << total_num_transfers << " transfers\n";
    uint32_t eth_core = eth_receiver_noc_x | (eth_receiver_noc_y << 16);
    // DPRINT << "rwr " << ID << " eth_core (encoded Y|X): " << eth_core << "\n";
    // DPRINT << "rwr " << ID << " eth L1 semaphore address: " << eth_receiver_l1_semaphore_addr << "\n";
