...
void MAIN {
    ...
    constexpr uint32_t in1_cb_id_inplace[2] = {1, 4};
    ...
    mm_block_init(in0_cb_id, in1_cb_id, mm_partials_cb_id, false, out_subblock_w, out_subblock_h, in0_block_w / 2 );
            ...
            for(uint32_t i = 0; i < 2; ++i) {
                ...
                for (uint32_t in0_subblock = 0; in0_subblock < in0_num_subblocks; in0_subblock++) {
                    ...
                    for (uint32_t in1_subblock = 0; in1_subblock < in1_num_subblocks; in1_subblock++) {
                        ...
                        tile_regs_acquire();
                        if (enable_reload and i == 1) {
                            reload_from_cb_to_dst(in0_cb_id, in1_cb_id, mm_partials_cb_id, out_subblock_num_tiles, out_subblock_w, out_subblock_h, in0_block_w / 2);
                        }
                        ...
                        for (uint32_t inner_dim_idx = 0; inner_dim_idx < in0_block_w / 2; ++inner_dim_idx) {
                            // matmul outer product of (out_subblock_h x out_subblock_w) tiles that fill dst
                            // accumulation is done by iterating matmul_block across inner dim
                            // in0_block_w is passed as innder dim (kt) to matmul_block, interally used to stride in0
                            matmul_block(in0_cb_id, in1_cb_id, in0_index, in1_index, dst_index, false, out_subblock_w, out_subblock_h, in0_block_w / 2);
                    ...
                    in0_index_subblock_offset += in0_subblock_num_tiles;
                        ...
                        if (block == num_blocks - 1 and i == 0) { enable_reload = true; } // reload when last iteration
                    #endif
                #else
