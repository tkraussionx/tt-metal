...
void MAIN {
    ...
    // dummy warmup loops
    // 20000 iterations cause segfault
    mm_block_init(in0_cb_id, in1_cb_id, mm_partials_cb_id, false, 1, 1, 1 );
    for(uint32_t block = 0; block < 30000; block++) {
        matmul_block(in0_cb_id, in1_cb_id, 0, 0, 0, false, 1, 1, 1);
    }
