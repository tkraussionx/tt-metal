...
ALWI void sleep(uint32_t loop_count = 100000) {
...
void MAIN {
    ...
    uint32_t in1_weight_slice_num_tiles = in0_num_blocks_w * in0_block_w * in1_block_w;
    ...
    for(uint32_t in1_block_w_i = 0; in1_block_w_i < in1_num_blocks_w; ++in1_block_w_i) {
        ...
        for(uint32_t in0_block_h_i = 0; in0_block_h_i < in0_num_blocks_h; ++in0_block_h_i) {
            ...
            for(uint32_t in0_block_w_i = 0; in0_block_w_i < in0_num_blocks_w; ++in0_block_w_i) {
                ...
                // MATH(( DPRINT << in1_block_w_i << "," << in0_block_h_i << "," << in0_block_w_i << ENDL() ));
                ...
                for (uint32_t in0_subblock_i = 0; in0_subblock_i < in0_num_subblocks; ++in0_subblock_i) {
                    ...
                    for (uint32_t in1_subblock_i = 0; in1_subblock_i < in1_num_subblocks; ++in1_subblock_i) {
                        ...
                        for (uint32_t i = 0; i < out_subblock_num_tiles; ++i) {
                            pack_tile(i, curr_matmul_out_cb);
                        }
        ...
        #endif
        cb_pop_front(in1_cb_id, in1_weight_slice_num_tiles);
