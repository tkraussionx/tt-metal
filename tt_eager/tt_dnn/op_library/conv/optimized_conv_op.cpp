...
CircularBufferID create_CBs(tt_metal::Program &program,
    ...
    if (input.memory_config().is_sharded()) {
        CircularBufferConfig cb_sharded_act_config = CircularBufferConfig(num_cb0_tiles * single_tile_size, {{sharded_act_cb, tt::DataFormat::Float16_b}})
		    .set_page_size(sharded_act_cb, num_cb0_tiles * single_tile_size);
    ...
    if (rn50_first_conv) {
        ...
        if (weight_size_h == 1 && weight_size_w == 1) {
            ...
            if (act_block_w_equals_input_channels_x_filter_width) {
                ...
                if (weight_size_h == 3 && weight_size_w == 3 && stride_h == 1 && not weight_width_sliced) {
