            ...
            if (i == 0 and b == 0) {
                ...
                if constexpr(fuse_gamma) {
                    ...
                    for (uint32_t w = 0; w < num_cols_tile_gamma_beta; w++) {
                        ...
                        noc_async_read<true>(gamma_noc_addr, l1_write_addr_gamma, 32);
                        gamma_noc_addr += 32;
                        noc_async_read<true>(gamma_noc_addr, l1_write_addr_gamma + 512, 32);
                ...
                if constexpr(fuse_beta) {
                    ...
                    for (uint32_t w = 0; w < num_cols_tile_gamma_beta; w++) {
                        ...
                        noc_async_read<true>(beta_noc_addr, l1_write_addr_beta, 32);
                        beta_noc_addr += 32;
                        noc_async_read<true>(beta_noc_addr, l1_write_addr_beta + 512, 32);
