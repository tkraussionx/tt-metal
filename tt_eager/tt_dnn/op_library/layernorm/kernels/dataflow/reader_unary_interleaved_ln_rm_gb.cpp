            ...
            for (uint32_t wt = 0; wt<Wt; wt += blk) {
                #ifdef FUSE_GAMMA
                {
                    ...
                    for (uint32_t r = 0; r<blk; r++) {
                        ...
                        noc_async_read<true>(gamma_noc_addr, l1_write_addr, 32);
                        gamma_noc_addr += 32;
                        noc_async_read<true>(gamma_noc_addr, l1_write_addr + 512, 32);
                ...
                #ifdef FUSE_BETA
                {
                    ...
                    for (uint32_t r = 0; r<blk; r++) {
                        ...
                        noc_async_read<true>(beta_noc_addr, l1_write_addr, 32);
                        beta_noc_addr += 32;
                        noc_async_read<true>(beta_noc_addr, l1_write_addr + 512, 32);
