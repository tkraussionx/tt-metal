...
inline Tensor interleaved_to_sharded(
    ...
    std::cout << "Running interleaved_to_sharded" << std::endl;
    Tensor output_tensor;
    output_tensor.device_synchronous = input_tensor.device_synchronous;
    input_tensor.device_synchronous->push_work([input_tensor, output_tensor, grid, shard_shape, shard_scheme, shard_orientation, output_dtype] () mutable {
...
inline Tensor interleaved_to_sharded(
    ...
    Tensor output_tensor;
    output_tensor.device_synchronous = input_tensor.device_synchronous;
    input_tensor.device_synchronous->push_work([input_tensor, output_tensor, sharded_mem_config, output_dtype] () mutable {
