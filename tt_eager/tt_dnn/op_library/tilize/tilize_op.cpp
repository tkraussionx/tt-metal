...
operation::ProgramWithCallbacks Tilize::create_program(
    ...
    switch (this->get_parallelization_strategy(input_tensors)) {
        case TilizeOpParallelizationStrategy::MULTI_CORE: return tilize_multi_core(input_tensor_a, output_tensor);
        case TilizeOpParallelizationStrategy::SINGLE_CORE:
        default: return tilize_single_core(input_tensor_a, output_tensor);
    }
}
...
operation::ProgramWithCallbacks TilizeWithValPadding::create_program(
    ...
    switch (this->get_parallelization_strategy(input_tensors)) {
        case TilizeWithValPaddingOpParallelizationStrategy::MULTI_CORE:
            return tilize_with_val_padding_multi_core(input_tensor_a, output_tensor, this->pad_value);
        case TilizeWithValPaddingOpParallelizationStrategy::SINGLE_CORE:
        default: return tilize_with_val_padding_single_core(input_tensor_a, output_tensor, this->pad_value);
    }
}

TilizeWithValPaddingOpParallelizationStrategy TilizeWithValPadding::get_parallelization_strategy(
...
Tensor tilize_with_zero_padding(
    ...
    return tilize_with_val_padding(input_tensor_a, shape, 0, output_mem_config, output_dtype, use_multicore);
}
