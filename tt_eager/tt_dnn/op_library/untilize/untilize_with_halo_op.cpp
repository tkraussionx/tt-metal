...
operation::ProgramWithCallbacks untilize_with_halo_multi_core_s2(const Tensor& input, Tensor& output, uint32_t pad_val, uint32_t in_b, uint32_t in_h, uint32_t in_w, uint32_t max_out_nsticks_per_core, const PoolConfig& pc) {
    ...
    for (uint32_t i = 0; i < ncores; ++ i) {
        ...
        // LL
        writer_rt_args[60] = updated_count_to_send[i][0] * in_stick_nbytes;
        ...
        // L
        writer_rt_args[63] = updated_count_to_send[i][1] * in_stick_nbytes;
        ...
        // R
        writer_rt_args[66] = updated_count_to_send[i][3] * in_stick_nbytes;
        ...
        // RR
        writer_rt_args[69] = updated_count_to_send[i][4] * in_stick_nbytes;
...
tt::stl::reflection::Attributes UntilizeWithHalo::attributes() const {
    return {
        ...
        {"in_h", this->in_h},
        {"in_w", this->in_w},
        {"max_out_nsticks_per_core_", this->max_out_nsticks_per_core_},
        {"stride", stride_},
