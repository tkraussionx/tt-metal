    ...
    void TensorModuleDMOPs( py::module & m_tensor)
    {
        ...
        */
        ...
        m_tensor.def("reduce_scatter", &reduce_scatter,
            // py::arg("input_tensors"), py::arg("scatter_split_dim"), py::arg("reduce_op") = ReduceOpMath::SUM, py::arg("num_links") = 1, py::arg("output_mem_config").noconvert() = operation::DEFAULT_OUTPUT_MEMORY_CONFIG,
