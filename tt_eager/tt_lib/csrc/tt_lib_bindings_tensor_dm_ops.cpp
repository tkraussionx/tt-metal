    ...
    void TensorModuleDMOPs( py::module & m_tensor)
    {
        ...
        */
        ...
        m_tensor.def("all_gather", &all_gather,
            py::arg("input_tensors"), py::arg("dim"), py::arg("num_links") = 1, py::arg("output_mem_config").noconvert() = operation::DEFAULT_OUTPUT_MEMORY_CONFIG, py::arg("num_workers") = 0, py::arg("max_channel_size") = 0,
