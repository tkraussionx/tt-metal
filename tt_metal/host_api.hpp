...
// ==================================================
/**
 * Creates a DRAM Buffer object and invokes DRAM allocator to reserves address space for it. DRAM buffers exist independently from a program
 *
...
/**
 * Creates a DRAM Buffer at an address generated by DRAM allocator. DRAM buffers exist independently from a program
 *
 * Return value: DramBuffer *
 *
 * | Argument      | Description                                  | Type     | Valid Range                                           | Required |
...
/**
 * Creates a L1 buffer at specified address and core adds it to the program. L1 allocator does not track buffers with manually specified addresses.
...
/**
 * Allocates and creates a L1 buffer at specified core. L1 allocator is responsible for generating address.
