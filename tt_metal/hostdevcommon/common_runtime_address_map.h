...
constexpr static std::uint32_t PROFILER_L1_OPTIONAL_MARKER_COUNT = 4;

constexpr static std::uint32_t PROFILER_L1_VECTOR_SIZE = (PROFILER_L1_OPTIONAL_MARKER_COUNT + PROFILER_L1_GUARANTEED_MARKER_COUNT) * PROFILER_L1_MARKER_UINT32_SIZE;
...
constexpr static std::uint32_t PROFILER_OP_SUPPORT_COUNT = 2000;

constexpr static std::uint32_t PROFILER_FULL_HOST_BUFFER_SIZE_PER_RISC = PROFILER_L1_MARKER_BYTES_SIZE * PROFILER_L1_GUARANTEED_MARKER_COUNT * PROFILER_OP_SUPPORT_COUNT;
...
constexpr static std::uint32_t PROFILER_HUGE_PAGE_ADDRESS = 1024 * 1024 * 1024 - PROFILER_FULL_HOST_BUFFER_SIZE;
