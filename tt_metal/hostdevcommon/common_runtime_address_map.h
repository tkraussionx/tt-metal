...
constexpr static std::uint32_t PROFILER_L1_PROGRAM_ID_UINT32_SIZE = 2;
...
constexpr static std::uint32_t PROFILER_L1_VECTOR_SIZE = (PROFILER_L1_OPTIONAL_MARKER_COUNT + PROFILER_L1_GUARANTEED_MARKER_COUNT) * PROFILER_L1_MARKER_UINT32_SIZE + PROFILER_L1_PROGRAM_ID_UINT32_SIZE;
