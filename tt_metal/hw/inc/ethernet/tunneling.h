...
FORCE_INLINE void eth_tunnel_src_forward_one_cmd(db_cb_config_t *eth_db_cb_config, uint32_t relay_noc_encoding, uint32_t* remote_issue_cmd_slots) {
...
// Implement yielding if SENDER is not ISSUE, this may help with devices getting commands first
template <uint8_t buffer_id, uint8_t other_buffer_id, bool sender_is_issue_path>
FORCE_INLINE void eth_tunnel_dst_forward_one_cmd(db_cb_config_t *eth_db_cb_config, uint32_t relay_noc_encoding, uint32_t* remote_issue_cmd_slots) {
