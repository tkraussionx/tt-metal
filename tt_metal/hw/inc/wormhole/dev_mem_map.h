...
#define MEM_ERISC_L1_SIZE          (256 * 1024)
...
#define MEM_ERISC_LOCAL_SIZE  (4 * 1024)

#define MEM_NCRISC_IRAM_BASE  0xFFC00000
#define MEM_NCRISC_IRAM_SIZE  (16 * 1024)
// #define MEM_ERISC_IRAM_BASE   0xFFC00000
// #define MEM_ERISC_IRAM_SIZE   (16 * 1024)
...
#define MEM_ERISC_FIRMWARE_SIZE        (4 * 1024)
...
// In its own core
#define MEM_ERISC_FIRMWARE_BASE        (0x9040) // Placing here until we allow support to overwrite the base firmware
...
#define MEM_ERISC_INIT_LOCAL_L1_BASE      (MEM_ERISC_FIRMWARE_BASE + MEM_ERISC_FIRMWARE_SIZE)

#define MEM_NCRISC_INIT_IRAM_L1_BASE      (MEM_TRISC2_INIT_LOCAL_L1_BASE + MEM_TRISC_LOCAL_SIZE)
// #define MEM_ERISC_INIT_IRAM_L1_BASE       (MEM_ERISC_INIT_LOCAL_L1_BASE + MEM_ERISC_LOCAL_SIZE)
...
#define MEM_ERISC_STACK_BASE  (MEM_LOCAL_BASE + MEM_ERISC_LOCAL_SIZE - MEM_ERISC_STACK_SIZE)
