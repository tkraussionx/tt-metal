...
struct address_map {
  ...
  static constexpr std::int32_t PRINT_BUFFER_SIZE = 224 ;
  ...
  static constexpr std::int32_t ERISC_MEM_MAILBOX_BASE = COMMAND_Q_BASE - PRINT_BUFFER_SIZE - PROFILER_L1_BUFFER_SIZE - PROFILER_L1_CONTROL_BUFFER_SIZE - 128 - 12;  // See dev_msgs.h and dev_mem_map.h for restrictions
  static constexpr std::int32_t PRINT_BUFFER_ER = ERISC_MEM_MAILBOX_BASE + 128 + 12;
  static constexpr std::uint32_t PROFILER_L1_BUFFER_ER = PRINT_BUFFER_ER + PRINT_BUFFER_SIZE;
  ...
  static_assert((PROFILER_L1_BUFFER_CONTROL + PROFILER_L1_CONTROL_BUFFER_SIZE) == COMMAND_Q_BASE);
