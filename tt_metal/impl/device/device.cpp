...
Device::Device(
    ...
    this->initialize(l1_small_size, trace_region_size, l1_bank_remap, minimal);
}
...
void Device::compile_command_queue_programs() {
    ...
    if (this->is_mmio_capable()) {
        ...
        log_debug(LogDevice, "run prefetch_d at {}", prefetch_d_core.str());
...
bool Device::initialize(size_t l1_small_size, size_t trace_region_size, const std::vector<uint32_t> &l1_bank_remap, bool minimal) {
    ZoneScoped;
