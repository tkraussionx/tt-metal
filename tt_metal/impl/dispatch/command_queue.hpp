...
class EnqueueReadBufferCommand : public Command {
   ...
   public:
    ...
    EnqueueReadBufferCommand(Device* device, Buffer& buffer, void* dst, CommandQueueWriter& writer, const uint32_t command_queue_channel);
...
class EnqueueWriteBufferCommand : public Command {
   ...
   public:
    EnqueueWriteBufferCommand(Device* device, Buffer& buffer, const void* src, CommandQueueWriter& writer, const uint32_t command_queue_channel);
...
class EnqueueProgramCommand : public Command {
   ...
   public:
    EnqueueProgramCommand(Device*, Buffer&, ProgramMap&, CommandQueueWriter&, const Program& program, bool stall, const uint32_t command_queue_channel);
...
class FinishCommand : public Command {
   ...
   public:
    FinishCommand(Device* device, CommandQueueWriter& writer, const uint32_t command_queue_channel);
...
class EnqueueWrapCommand : public Command {
   ...
   public:
    EnqueueWrapCommand(Device* device, CommandQueueWriter& writer, const uint32_t command_queue_channel);
