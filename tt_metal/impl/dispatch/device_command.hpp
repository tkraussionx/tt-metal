...
struct CommandHeader {
    ...
    uint32_t is_event_sync = 0;
    uint32_t event_sync_core_x = 0;
    uint32_t event_sync_core_y = 0;
...
class DeviceCommand {
   public:
    ...
    void set_is_event_sync(const uint32_t is_event_sync);
    void set_event_sync_core_x(const uint32_t event_sync_core_x);
    void set_event_sync_core_y(const uint32_t event_sync_core_y);
