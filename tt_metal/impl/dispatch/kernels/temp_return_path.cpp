...
void kernel_main() {
    ...
    uint32_t producer_noc_encoding = uint32_t(NOC_XY_ENCODING(6, 10));
    ...
    db_cb_config_t *eth_dst_db_cb_config = sender_is_issue_path ? get_local_db_cb_config(eth_l1_mem::address_map::COMPLETION_CQ_CB_BASE, false) :
                                                                  get_local_db_cb_config(eth_l1_mem::address_map::ISSUE_CQ_CB_BASE, false);
