...
struct ProgramCommandIndices {
    ...
    std::unordered_map<uint32_t, std::vector<std::array<uint32_t, 4>>> processor_to_cmd_mapping;
    std::unordered_map<uint32_t, std::vector<std::array<uint32_t, 4>>> kernel_to_cmd_mapping;
