...
#ifdef TRISC_MATH
#include "llk_math_eltwise_unary_sfpu_moreh_mul_sub.h"
 ...
 */
template <bool fast_and_approx = false>
ALWI void moreh_mul_sub(uint32_t idst) {
    MATH(( llk_math_eltwise_unary_sfpu_moreh_mul_sub<fast_and_approx>(idst) ));
}
