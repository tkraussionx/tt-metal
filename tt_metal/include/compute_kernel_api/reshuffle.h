 ...
 */
ALWI void reshuffle_rows_tile(uint32_t idst, uint32_t idx_addr, uint32_t subtile) {
    MATH(( llk_math_eltwise_unary_sfpu_reshuffle_rows<APPROX>(idst,idx_addr,subtile) ));
}
