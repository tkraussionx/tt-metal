...
void kernel_main() {
    ...
    // DPRINT << "NCRISC src0_num_tiles: " << src0_num_tiles << ENDL();
    // DPRINT << "NCRISC src1_num_tiles: " << src0_num_tiles << ENDL();
    ...
    for (uint32_t i=0; i<num_tiles; i += ublock_size_tiles) {
        ...
        if (i < src0_num_tiles) {
            ...
            // DPRINT << "Reserve starting i: " << i << ENDL();
            cb_reserve_back(cb_id_in0, ublock_size_tiles);
            // DPRINT << "Reserve ending i: " << i << ENDL();
            ...
            // DPRINT << "Push back starting i: " << i << ENDL();
            cb_push_back(cb_id_in0, ublock_size_tiles);
            // DPRINT << "Push back ending i: " << i << ENDL();
