...
void kernel_main() {
    ...
    uint32_t output_tile_start_id = dataflow::get_arg_val<uint32_t>(9);
    uint32_t num_output_tiles     = dataflow::get_arg_val<uint32_t>(10);
    uint32_t MtNt                 = dataflow::get_arg_val<uint32_t>(11);
