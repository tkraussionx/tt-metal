...
void kernel_main() {
    ...
    // in0 mcast args
    uint32_t in1_mcast_dest_noc_start_x         = dataflow::get_arg_val<uint32_t>(17);
    uint32_t in1_mcast_dest_noc_start_y         = dataflow::get_arg_val<uint32_t>(18);
    uint32_t in1_mcast_dest_noc_end_x           = dataflow::get_arg_val<uint32_t>(19);
    uint32_t in1_mcast_dest_noc_end_y           = dataflow::get_arg_val<uint32_t>(20);
    uint32_t in1_mcast_num_dests                = dataflow::get_arg_val<uint32_t>(21);
    uint32_t in1_mcast_sender_noc_x             = dataflow::get_arg_val<uint32_t>(22);
    uint32_t in1_mcast_sender_noc_y             = dataflow::get_arg_val<uint32_t>(23);
    uint32_t in1_mcast_sender_semaphore_addr    = dataflow::get_arg_val<uint32_t>(24);
    uint32_t in1_mcast_receiver_semaphore_addr  = dataflow::get_arg_val<uint32_t>(25);

    // batch args
    uint32_t MtKt                               = dataflow::get_arg_val<uint32_t>(26); // if 0
    uint32_t KtNt                               = dataflow::get_arg_val<uint32_t>(27);
    uint32_t batch                              = dataflow::get_arg_val<uint32_t>(28);
    uint32_t bcast_B                            = dataflow::get_arg_val<uint32_t>(29);

    // padding args
    uint32_t last_block_h                       = dataflow::get_arg_val<uint32_t>(30);
    uint32_t last_block_w                       = dataflow::get_arg_val<uint32_t>(31); // not used
