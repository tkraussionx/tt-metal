...
void kernel_main() {
    ...
    // batch args
    uint32_t MtKt                               = dataflow::get_arg_val<uint32_t>(17); // if 0
    uint32_t KtNt                               = dataflow::get_arg_val<uint32_t>(18);
    uint32_t batch                              = dataflow::get_arg_val<uint32_t>(19);
    uint32_t bcast_B                            = dataflow::get_arg_val<uint32_t>(20);

    // WRITER
    // out tensor args
    uint32_t out_tensor_addr                    = dataflow::get_arg_val<uint32_t>(21);
    uint32_t out_tensor_start_tile_id           = dataflow::get_arg_val<uint32_t>(22);
    uint32_t out_tensor_stride_w                = dataflow::get_arg_val<uint32_t>(23);
    uint32_t out_tensor_stride_h                = dataflow::get_arg_val<uint32_t>(24);
    uint32_t out_tensor_next_subblock_stride_w  = dataflow::get_arg_val<uint32_t>(25);
    uint32_t out_tensor_next_subblock_stride_h  = dataflow::get_arg_val<uint32_t>(26);

    // out subblock args
    uint32_t out_subblock_w                     = dataflow::get_arg_val<uint32_t>(27);
    uint32_t out_subblock_h                     = dataflow::get_arg_val<uint32_t>(28);
    uint32_t out_subblock_tile_count            = dataflow::get_arg_val<uint32_t>(29);
    uint32_t out_num_subblocks_w                = dataflow::get_arg_val<uint32_t>(30);
    uint32_t out_num_subblocks_h                = dataflow::get_arg_val<uint32_t>(31);

    // batch args
    uint32_t MtNt                               = dataflow::get_arg_val<uint32_t>(32); // if 0
    ...
    uint32_t single_tile_size_bytes = dataflow::get_tile_size(cb_id_in1);
