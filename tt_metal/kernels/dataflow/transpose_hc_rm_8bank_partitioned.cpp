        ...
        for (uint32_t n = 0; n < N; n++) {
            for (uint32_t h = 0; h < H_S; h++) {
                for (uint32_t c = 0; c < C_S; c++) {
                    ...
                    dataflow::noc_async_read(src_noc_addr, l1_addr, (W<<1)); // TODO(AP): segment this read
                    ...
                    dataflow::noc_async_write(l1_addr, dst_noc_addr, (W<<1)); // TODO(AP): segment this write
