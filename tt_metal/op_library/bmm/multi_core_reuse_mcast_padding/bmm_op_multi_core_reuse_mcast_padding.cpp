...
tt_metal::Program * create_program_mcast_in0_in1(
    ...
    auto mm_reader_kernel_in0_sender_in1_receiver = tt_metal::CreateDataMovementKernel(
        program,
        "kernels/dataflow/reader_bmm_tile_layout_in0_sender_in1_receiver_padding.cpp",
    ...
    auto mm_reader_kernel_in0_receiver_in1_sender = tt_metal::CreateDataMovementKernel(
        program,
        "kernels/dataflow/reader_bmm_tile_layout_in0_receiver_in1_sender_padding.cpp",
...
Tensor matmul_multi_core_reuse_mcast_padding_(const Tensor &a, const Tensor &b, bool bcast_batch, bool profile_device) {
    ...
    if (core_range.x > 1 && core_range.y > 1) {
        ...
        parallelization = "multi_core_reuse_mcast_in0_in1_padding";
        ...
        parallelization = "multi_core_reuse_mcast_in0_padding";
    } else {
        ...
        parallelization = "multi_core_reuse_mcast_in1_padding";
    }
...
Tensor matmul_multi_core_reuse_mcast_padding(const Tensor& a, const Tensor& b, bool profile_device) {
    return matmul_multi_core_reuse_mcast_padding_(a, b, true, profile_device);
}

Tensor bmm_multi_core_reuse_mcast_padding(const Tensor& a, const Tensor& b, bool profile_device) {
    return matmul_multi_core_reuse_mcast_padding_(a, b, false, profile_device);
}
