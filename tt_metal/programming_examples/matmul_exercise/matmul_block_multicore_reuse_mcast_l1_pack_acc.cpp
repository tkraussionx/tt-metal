...
void matmul_multicore_reuse_mcast(vector<bfloat16>& a, vector<bfloat16>& b, vector<bfloat16>& output,
                        uint32_t M, uint32_t N, uint32_t K, Device* device) {
    ...
    */
    ...
    auto mm_reader_kernel_in0_sender_in1_sender_id = tt_metal::CreateKernel(
        program,
        "tt_metal/programming_examples/matmul_exercise/kernels/dataflow/reader_matmul_mcast_in0_sender_in1_sender.cpp",
    ...
    auto mm_reader_kernel_in0_sender_in1_receiver_id = tt_metal::CreateKernel(
        program,
        "tt_metal/programming_examples/matmul_exercise/kernels/dataflow/reader_matmul_mcast_in0_sender_in1_receiver.cpp",
        in0_sender_in1_receiver,
        tt_metal::DataMovementConfig{.processor = tt_metal::DataMovementProcessor::RISCV_1, .noc = tt_metal::NOC::RISCV_0_default, .compile_args = reader_compile_time_args});

    auto mm_reader_kernel_in0_receiver_in1_sender_id = tt_metal::CreateKernel(
        program,
        "tt_metal/programming_examples/matmul_exercise/kernels/dataflow/reader_matmul_mcast_in0_receiver_in1_sender.cpp",
        in0_receiver_in1_sender,
        tt_metal::DataMovementConfig{.processor = tt_metal::DataMovementProcessor::RISCV_1, .noc = tt_metal::NOC::RISCV_1_default, .compile_args = reader_compile_time_args});

    auto mm_reader_kernel_in0_receiver_in1_receiver_id = tt_metal::CreateKernel(
        program,
        "tt_metal/programming_examples/matmul_exercise/kernels/dataflow/reader_matmul_mcast_in0_receiver_in1_receiver.cpp",
    ...
    auto mm_kernel_id = tt_metal::CreateKernel(
        program,
        "tt_metal/programming_examples/matmul_exercise/kernels/compute/matmul_block_multicore_reuse_l1_pack_acc.cpp",
        all_cores,
...
int main(int argc, char **argv) {
    ...
    try {
        ...
        matmul_multicore_reuse_mcast(src0_vec, src1_vec, result_vec, M, N, K, device);
