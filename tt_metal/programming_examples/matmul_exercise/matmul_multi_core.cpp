...
void golden_matmul(vector<bfloat16>& a, vector<bfloat16>& b, vector<bfloat16>& output,
                        uint32_t M, uint32_t N, uint32_t K, bool transpose = false) {
...
void matmul_multi_core(vector<bfloat16>& a, vector<bfloat16>& b, vector<bfloat16>& output, bool transpose_b,
    ...
    */
    ...
    log_info(tt::LogVerif, "num_cores {} num_output_tiles_per_core_group_1 {} num_output_tiles_per_core_group_2 {}", num_cores, num_output_tiles_per_core_group_1, num_output_tiles_per_core_group_2);
    ...
    */
    auto reader_id = tt_metal::CreateKernel(
        program,
        "tt_metal/programming_examples/matmul_exercise/kernels/dataflow/reader_matmul_multi_core.cpp",
        all_cores,
        tt_metal::DataMovementConfig{.processor = DataMovementProcessor::RISCV_1, .noc = NOC::RISCV_1_default, .compile_args = reader_compile_time_args});

    auto writer_id = tt_metal::CreateKernel(
        program,
        "tt_metal/programming_examples/matmul_exercise/kernels/dataflow/writer_matmul_multi_core.cpp",
        all_cores,
    ...
    auto matmul_multi_core_kernel_group_1_id = tt_metal::CreateKernel(
        program,
        "tt_metal/programming_examples/matmul_exercise/kernels/compute/matmul_multi_core.cpp",
        core_group_1,
...
int main(int argc, char **argv) {
    ...
    try {
        ...
        matmul_multi_core(src0_vec, src1_vec, result_vec, transpose_b, M, N, K, device);
