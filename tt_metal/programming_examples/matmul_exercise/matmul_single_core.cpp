...
void matmul_single_core(vector<bfloat16>& a, vector<bfloat16>& b, vector<bfloat16>& output, bool transpose_b,
    ...
    */
    tt_metal::SetRuntimeArgs(
        ...
        {src0_addr, src1_addr, Mt, Kt, Nt, Mt*Kt, Kt*Nt, uint32_t(transpose_b ? 1 : 0)}
    );
