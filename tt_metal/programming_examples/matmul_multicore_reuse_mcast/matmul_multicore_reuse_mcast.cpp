...
void matmul_multicore_reuse_mcast(vector<bfloat16>& a, vector<bfloat16>& b, vector<bfloat16>& output, bool bcast_batch,
    ...
    */
    ...
    tt::DataFormat in0_data_format = tt::DataFormat::Float16_b;
    tt::DataFormat in1_data_format = tt::DataFormat::Float16_b;
    tt::DataFormat bias_data_format = tt::DataFormat::Float16_b;
    tt::DataFormat output_data_format = tt::DataFormat::Float16_b;
    ...
    */
    ...
    auto in0_buffer = CreateBuffer(dram_config_A);
    auto in1_buffer = CreateBuffer(dram_config_B);
    auto out_buffer = CreateBuffer(dram_config_C);

    // USER DEFINED
    tt_metal::Buffer* bias_buffer = nullptr;
    // std::optional<UnaryWithParam> fused_activation;

    uint32_t in0_addr = in0_buffer->address();
    uint32_t in1_addr = in1_buffer->address();
    ...
    EnqueueWriteBuffer(cq, in0_buffer, a.data(), false);
    EnqueueWriteBuffer(cq, in1_buffer, b.data(), false);
    EnqueueProgram(cq, program, false);
    EnqueueReadBuffer(cq, out_buffer, output.data(), true);
}
