...
PROGRAMMING_EXAMPLES_LDFLAGS = -ltt_metal_impl -ltt_metal_detail -ltt_metal -lllrt -ltt_gdb -ldevice -lbuild_kernels_for_riscv -ldl -lcommon -lprofiler -lstdc++fs -pthread -lyaml-cpp -ltracy -L/usr/lib/x86_64-linux-gnu/ -lOpenCL
