...
int main() {
  ...
  // EnqueueWriteBuffer(cq, device_buffer0 /*device buffer*/, host_buffer0.get(),
  //                    true /*blocking*/);
  ...
  // // Set writer runtime arguments
  // const std::vector<uint32_t> writer_runtime_args = {/*TODO*/};
  // SetRuntimeArgs(/* TODO */);

  // // Set compute runtime arguments
  // const std::vector<uint32_t> compute_runtime_args = {/*TODO*/};
  // SetRuntimeArgs(/* TODO */);
