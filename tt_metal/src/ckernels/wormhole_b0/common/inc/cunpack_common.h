...
namespace ckernel::unpacker
{
     ...
     bool is_fp32_dest_acc_en=false)
   {
      ...
      cfg_reg_rmw_tensix<ALU_FORMAT_SPEC_REG_SrcA_val_ADDR32, ALU_FORMAT_SPEC_REG_SrcA_val_SHAMT, mask0, p_gpr_unpack::TMP0, p_gpr_unpack::TMP1>(alu_src_format);
      ...
      cfg_reg_rmw_tensix<ALU_FORMAT_SPEC_REG0_SrcA_ADDR32, 0, mask1, p_gpr_unpack::TMP0, p_gpr_unpack::TMP1>(alu_payload.val);
      ...
      TTI_SETADCXX(p_setadc::UNP0, (srca_face_height << 4)-1, 0x0);
      if (row_pool) {
         TTI_SETADCXX(p_setadc::UNP1, (1 << 4)-1, 0x0);
      } else {
      ...
      // unpacker0 needs to keep appending to srcA new faces
      cfg_rmw(THCON_SEC0_REG2_Unpack_Src_Reg_Set_Upd_RMW, 1);
