...
#define MEM_RUN_MAILBOX_ADDRESS        (MEM_MAILBOX_BASE +   4) // 4 bytes * 5 cores
#define MEM_ENABLE_NCRISC_MAILBOX_ADDRESS (MEM_MAILBOX_BASE + 24) // 1 * 4 bytes
#define MEM_ENABLE_TRISC_MAILBOX_ADDRESS  (MEM_MAILBOX_BASE + 28) // 1 * 4 bytes
#define MEM_FWLOG_MAILBOX_ADDRESS      (MEM_MAILBOX_BASE +  32) // 4 * 5 bytes * 5 cores
#define MEM_FWEVENT_MAILBOX_ADDRESS    (MEM_MAILBOX_BASE + 132) // 4 bytes * 5 cores
#define MEM_WALL_CLOCK_MAILBOX_ADDRESS (MEM_MAILBOX_BASE + 152) // 4 bytes * 1 core (brisc)

#define MEM_DEBUG_STATUS_MAILBOX_START_ADDRESS   (MEM_MAILBOX_BASE + 160)
#define MEM_DEBUG_BRISC_STATUS_MAILBOX_ADDRESS   (MEM_MAILBOX_BASE + 160)  // 4 bytes
#define MEM_DEBUG_NCRISC_STATUS_MAILBOX_ADDRESS  (MEM_MAILBOX_BASE + 164)  // 4 bytes
#define MEM_DEBUG_TRISC0_STATUS_MAILBOX_ADDRESS  (MEM_MAILBOX_BASE + 168)  // 4 bytes
