...
#define   STREAM_LOCAL_DEST_REG_INDEX   2
...
#define   STREAM_GATHER_REG_INDEX   15
#define       MSG_ARB_GROUP_SIZE         0
...
#define   STREAM_MSG_SRC_IN_ORDER_FWD_NUM_MSGS_REG_INDEX   16

// Offset & size of the size field in the message header. Only valid offsets are multiples of 8
// (i.e. byte-aligned).
#define   STREAM_MSG_HEADER_FORMAT_REG_INDEX   17
...
#define   STREAM_NEXT_RECEIVED_MSG_ADDR_REG_INDEX   19
...
// condition.)
#define   STREAM_SOURCE_ENDPOINT_NEW_MSG_INFO_REG_INDEX   29
...
// phase number.)
#define   STREAM_DEST_PHASE_READY_UPDATE_REG_INDEX   32
...
#define   STREAM_WAIT_STATUS_REG_INDEX   35
...
#define   STREAM_PHASE_AUTO_CFG_HEADER_REG_INDEX   36
...
#define   STREAM_PERF_CONFIG_REG_INDEX   37
...
#define   STREAM_MSG_INFO_FULL_REG_INDEX   39
...
#define   STREAM_GATHER_CLEAR_REG_INDEX   43
...
#define   STREAM_DEBUG_STATUS_SEL_REG_INDEX   45
...
#define   STREAM_BLOB_AUTO_CFG_DONE_REG_INDEX   234

// High bits for STREAM_REMOTE_DEST_BUF_START
#define   STREAM_REMOTE_DEST_BUF_START_HI_REG_INDEX   242

// High bits for STREAM_REMOTE_DEST_MSG_INFO_WR_PTR
#define   STREAM_REMOTE_DEST_MSG_INFO_WR_PTR_HI_REG_INDEX   243
...
#define   STREAM_CURR_PHASE_BASE_REG_INDEX   244
