...
namespace profiler {
    ...
    namespace detail {
        ...
        class OpProfiler {
            ...
            private:
                ...
                string join_vector(const vector<string>& strs, string delimiter = "-") const
                {
                    string ret = "";
                ...
                string shape_to_str(const array<uint32_t, 4> shape) const
                {
                ...
                string tensor_to_str(const Tensor& tensor) const
                {
    ...
    {
        detail::operationProfiler.append_input_data(input);
    }

    static void append_output_data (const Tensor& output)
    {
        detail::operationProfiler.append_output_data(output);
    }
    ...
    {
        detail::operationProfiler.set_preferred_name(name);
    }
    ...
    {
        detail::operationProfiler.set_parallelization_strategy(parlStrategy);
    }
