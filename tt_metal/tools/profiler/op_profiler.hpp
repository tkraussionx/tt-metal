        ...
        class OpProfiler {
            ...
            private:
                ...
                vector<pair<string,string>> generate_additional_data()
                {
                    ...
                    additionalFields.push_back({"PM Ideal Cycles", fmt::format("{}", opData.perf_model.get_ideal_cycle_count())});
                    ...
                    //additionalFields.push_back({"PM Req I BW", fmt::format("{}",opData.perf_model.get_input_bws())});
                    //additionalFields.push_back({"PM Req O BW", fmt::format("{}",opData.perf_model.get_output_bws())});
