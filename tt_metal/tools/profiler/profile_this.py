...
@click.option("-o", "--output_location", type=str, default=None, help="Path to output location")
def main(command, output_location):
    ...
    logger.info(f"output_location is {output_location}")

    if command:
        profile_command(command)
        post_process(output_location)
