...
# File: https://huggingface.co/tiiuae/falcon-7b-instruct/blob/main/modelling_RW.py
...
from tt_models.falcon.reference.deprecated.hf_configuration_RW import RWConfig
...
class Attention(nn.Module):
    def __init__(self, config: RWConfig):
        ...
        self.query_key_value = Linear(
            ...
            else (self.hidden_size + 2 * self.head_dim),
            bias=config.bias,
        )
    ...
    def forward(
        ...
        value_layer = value_layer.transpose(1, 2).reshape(
            batch_size * self.num_kv, q_length, self.head_dim
        )
