...
from tt_models.yolov3.reference.utils.dataloaders import (
    IMG_FORMATS,
    VID_FORMATS,
    LoadImages,
    LoadScreenshots,
...
from tt_models.yolov3.reference.utils.general import (
    LOGGER,
    Profile,
    check_file,
    check_img_size,
...
from tt_models.yolov3.reference.utils.plots import (
    Annotator,
    colors,
    save_one_box,
)
from tt_models.yolov3.reference.utils.torch_utils import (
    select_device,
    smart_inference_mode,
)

from tt_models.yolov3.yolov3_utils import model_location_generator

data_path = model_location_generator("tt_dnn-models/Yolo/data/")
models_path = model_location_generator("tt_dnn-models/Yolo/models/")


@smart_inference_mode()
def run(
    weights=str(models_path / "yolov3.pt"),  # model path or triton URL
    source=str(data_path / "images"),  # file/dir/URL/glob/screen/0(webcam)
    data=str(data_path / "coco128.yaml"),  # dataset.yaml path
...
def parse_opt():
    ...
    parser.add_argument(
        ...
        nargs="+",
        type=str,
        default=str(models_path / "yolov3.pt"),
        help="model path or triton URL",
    )
    parser.add_argument(
        "--source",
        type=str,
        default=str(data_path / "images"),
        help="file/dir/URL/glob/screen/0(webcam)",
    )
    parser.add_argument(
        "--data",
        type=str,
        default=str(data_path / "coco128.yaml"),
