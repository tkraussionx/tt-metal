...
from tt_models.yolov3.reference.utils import TryExcept
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(
        ...
        from tt_models.yolov3.reference.models.experimental import (
            attempt_download,
            attempt_load,
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from tt_models.yolov3.reference.export import export_formats
        from tt_models.yolov3.reference.utils.downloads import is_url
