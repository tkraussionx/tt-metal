...
from tt_models.yolov5.reference.utils.plots import (
    Annotator,
    colors,
    save_one_box,
)
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(
        ...
        from tt_models.yolov5.reference.models.experimental import (
            attempt_download,
            attempt_load,
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from tt_models.yolov5.reference.utils.downloads import is_url
