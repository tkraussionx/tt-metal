...
from tt_models.yolov5.tt.yolov5_conv import TtYolov5Conv
from tt_models.yolov5.tt.yolov5_c3 import TtYolov5C3
from tt_models.yolov5.tt.yolov5_bottleneck import TtYolov5Bottleneck
from tt_models.yolov5.tt.yolov5_sppf import TtYolov5SPPF
from tt_models.yolov5.tt.yolov5_upsample import TtYolov5Upsample
from tt_models.yolov5.tt.yolov5_concat import TtYolov5Concat
from tt_models.yolov5.tt.yolov5_detect import TtYolov5Detect
from pathlib import Path

import contextlib
import math

from tt_models.yolov5.reference.utils.general import make_divisible
from tt_models.yolov5.reference.utils.autoanchor import (
    check_anchor_order,
)

from tt_models.yolov5.reference.utils.torch_utils import (
    fuse_conv_and_bn,
    model_info,
    profile,
    scale_img,
...
def yolov5s_detection_model(device) -> TtYolov5DetectionModel:
    cfg_path = "tests/models/yolov5/reference/yolov5s.yaml"
