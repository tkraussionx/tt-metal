...
void py_module(py::module& module) {
    py::class_<DeviceMesh>(module, "DeviceMesh")
        ...
        .def("get_num_devices", &tt::tt_metal::DeviceMesh::num_devices)
        .def("get_device_ids", &tt::tt_metal::DeviceMesh::get_device_ids)
        .def(
            "get_device",
            py::overload_cast<int>(&tt::tt_metal::DeviceMesh::get_device, py::const_),
            py::return_value_policy::reference)
        .def(
            "get_device",
            py::overload_cast<int, int>(&tt::tt_metal::DeviceMesh::get_device, py::const_),
            py::return_value_policy::reference)
        .def("get_devices", &tt::tt_metal::DeviceMesh::get_devices, py::return_value_policy::reference, R"doc(
        ...
        .def(
            "get_devices_on_row",
            &tt::tt_metal::DeviceMesh::get_devices_on_row,
            py::return_value_policy::reference,
            R"doc(
        ...
        .def(
            ...
            &tt::tt_metal::DeviceMesh::get_devices_on_column,
            py::return_value_policy::reference,
            R"doc(
            Get the devices in a row of the device mesh.
        ...
        .def(
            ...
            &tt::tt_metal::DeviceMesh::compute_with_storage_grid_size,
            R"doc(
        ...
        .def("dram_grid_size", &tt::tt_metal::DeviceMesh::dram_grid_size,
        R"doc(
        ...
        .def("arch", &tt::tt_metal::DeviceMesh::arch,
        R"doc(
        ...
        .def_property_readonly("shape", &tt::tt_metal::DeviceMesh::shape, R"doc(
