...
operation::ProgramWithCallbacks layernorm_pre_allgather_multi_core(
    ...
    */
    ...
    auto reader_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/deprecated/tt_dnn/op_library/layernorm_distributed/kernels/dataflow/reader_unary_interleaved_ln_rm_gb_pre_allgather.cpp",
        all_cores,
    ...
    auto compute_kernels_id = CreateKernel(
        program,
        "ttnn/cpp/ttnn/deprecated/tt_dnn/op_library/layernorm_distributed/kernels/compute/layernorm_pre_allgather.cpp",
        all_cores,
    ...
    // c_in1 -> reduce scalar
    CircularBufferConfig cb_reduce_config = CircularBufferConfig(in1_tiles*bfloat16_tile_size, {{CB::c_in1, cb_data_format}}).set_page_size(CB::c_in1, bfloat16_tile_size);
