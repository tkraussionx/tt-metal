...
void MAIN {
    ...
    auto recip_bias_correction1_bits = get_arg_val<uint32_t>(i++);
    auto recip_bias_correction2_bits = get_arg_val<uint32_t>(i++);
    ...
    float param_in_scaler = (1 - lr * weight_decay);
    auto param_in_scaler_bits = get_bits(param_in_scaler);
