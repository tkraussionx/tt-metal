...
operation::ProgramWithCallbacks moreh_test2_impl(
    ...
    log_info(
        LogOp,
        "math_fidelity {} math_approx_mode {} fp32_dest_acc_en {} packer_l1_acc {} dst_full_sync-en {}",
        math_fidelity,
        math_approx_mode,
        fp32_dest_acc_en,
        packer_l1_acc,
    ...
    std::cout << " +_ + " << fp32_dest_acc_en << "\n";
    if (fp32_dest_acc_en) {
        unpack_to_dest_mode[CB::c_in0] = UnpackToDestMode::UnpackToDestFp32;
        unpack_to_dest_mode[CB::c_in2] = UnpackToDestMode::UnpackToDestFp32;
    }
