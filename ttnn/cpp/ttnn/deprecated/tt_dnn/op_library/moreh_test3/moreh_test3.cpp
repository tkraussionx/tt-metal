...
#include "ttnn/deprecated/tt_dnn/op_library/moreh_test3/moreh_test3_op.hpp"
...
operation::ProgramWithCallbacks moreh_test3_impl(
    ...
    const std::string reader_kernel_file = "ttnn/cpp/ttnn/deprecated/tt_dnn/op_library/moreh_test3/kernels/reader_test3.cpp";
    const auto reader_kernel_id = CreateReadKernel(program, reader_kernel_file, all_cores, reader_compile_time_args);

    std::vector<uint32_t> writer_compile_time_args = {static_cast<uint32_t>(is_dram(output))};
    const std::string writer_kernel_file = "ttnn/cpp/ttnn/deprecated/tt_dnn/op_library/moreh_test3/kernels/writer_test3.cpp";
    ...
    const auto compute_kernel_file = "ttnn/cpp/ttnn/deprecated/tt_dnn/op_library/moreh_test3/kernels/moreh_test3.cpp";
    const auto compute_kernel_1_id = CreateComputeKernel(
        ...
        /*preserve_fp32_precision=*/ unpack_to_dest_mode);
