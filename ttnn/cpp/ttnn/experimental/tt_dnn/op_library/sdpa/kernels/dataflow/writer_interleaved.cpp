...
#include "ttnn/cpp/ttnn/experimental/tt_dnn/kernels/dataflow/generate_reduce_mm_scaler.hpp"
...
void kernel_main() {
    ...
    generate_reduce_mm_scaler(cb_identity_scale_mm_in, identity_scalar_packed);
