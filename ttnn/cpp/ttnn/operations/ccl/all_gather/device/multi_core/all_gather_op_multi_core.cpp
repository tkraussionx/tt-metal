    ...
    for (uint32_t direction = 0; direction < num_full_send_directions; direction++) {
        ...
        for (uint32_t l = 0; l < num_links; ++l) {
            ...
            if (!is_linear || ring_index != ring_size - 1) {
                ...
                log_info(tt::LogOp, "\teth_sender_core on link {}: (x={},y={})", l, eth_sender_core.x, eth_sender_core.y);
            }
            if (!is_linear || ring_index != 0) {
                ...
                log_info(tt::LogOp, "\teth_receiver_core on link {}: (x={},y={})", l, eth_receiver_core.x, eth_receiver_core.y);
            }
        }
