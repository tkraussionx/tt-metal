...
operation::ProgramWithCallbacks ReduceScatter::create_program(
    ...
    return ccl::reduce_scatter_detail::reduce_scatter_with_workers(
        ...
        this->topology,
        this->user_defined_num_edm_channels,
...
Tensor reduce_scatter(
    ...
    operation::launch_op(
        [binary_op_type, scatter_dim, num_links, output_mem_config, topology, devices, user_defined_num_edm_channels, user_defined_num_buffers_per_channel](
