...
struct MorehLayernormDeviceOperation {
    ...
    // using shape_return_value_t = std::vector<std::optional<ttnn::Shape>>;
    // using shape_return_value_t = std::tuple<ttnn::Shape, ttnn::Shape, ttnn::Shape>;

    using shape_return_value_t = std::tuple<std::optional<ttnn::Shape>, std::optional<ttnn::Shape>, std::optional<ttnn::Shape>>;
    ...
    // output, mean, rstd
    using tensor_return_value_t = std::tuple<std::optional<Tensor>, std::optional<Tensor>, std::optional<Tensor>>;
