...
MorehLayernormDeviceOperation::MultiCore::cached_program_t MorehLayernormDeviceOperation::MultiCore::create(
...
void MorehLayernormDeviceOperation::MultiCore::override_runtime_arguments(
