...
operation::ProgramWithCallbacks layernorm_multi_core(
    ...
    auto reader_kernels_id = CreateKernel(
        program,
        use_row_major_kernel ? "ttnn/cpp/ttnn/operations/normalization/layernorm/device/kernels/dataflow/reader_unary_interleaved_ln_rm_gb.cpp" : "tt_eager/tt_dnn/op_library/layernorm/kernels/dataflow/reader_unary_interleaved_ln.cpp",
        all_cores,
