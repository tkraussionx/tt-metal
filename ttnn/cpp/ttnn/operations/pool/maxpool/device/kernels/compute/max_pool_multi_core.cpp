...
template<uint32_t in_ntiles_hw, uint32_t in_ntiles_c, uint32_t out_ntiles_c, bool is_partial_tile, uint32_t split_reader, uint32_t unpA_face_r_dim, uint32_t out_full_nblocks_c, uint32_t ntiles_c_per_block, uint32_t ntiles_c_per_block_last>
...
void MAIN {
    ...
    constexpr uint32_t out_ntiles_c = get_compile_time_arg_val(7);  // total num tiles to reduce and pack
    ...
    constexpr uint32_t out_full_nblocks_c = get_compile_time_arg_val(15); // number of blocks of max-8-tiles
    constexpr uint32_t ntiles_c_per_block = get_compile_time_arg_val(16); // number of tiles per block of max-8-tiles along c
    constexpr uint32_t ntiles_c_per_block_last = get_compile_time_arg_val(17); // remainder tiles along c
