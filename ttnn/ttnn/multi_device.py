...
def begin_multi_device_trace_capture(device_mesh, trace_buffer_size, cq_id=0):
    return ttnn._ttnn.multi_device.begin_trace_capture(device_mesh, trace_buffer_size, cq_id)


def end_multi_device_trace_capture(device_mesh, trace_id, cq_id=0):
    ttnn._ttnn.multi_device.end_trace_capture(device_mesh, trace_id, cq_id)


def execute_multi_device_trace(device_mesh, trace_id, cq_id=0, blocking=True):
