...
void matmul_multicore_reuse(vector<bfloat16>& a, vector<bfloat16>& b, vector<bfloat16>& output,
    ...
    for(int output_idx_y = 0; output_idx_y < num_blocks_y; output_idx_y++) {
        for(int output_idx_x = 0; output_idx_x < num_blocks_x; output_idx_x++) {
            ...
            std::vector<uint32_t> writer_args = {
                ...
                (std::uint32_t) output_idx_x * per_core_Nt + output_idx_y * per_core_Mt * Nt, // out_tensor_start_tile_id
